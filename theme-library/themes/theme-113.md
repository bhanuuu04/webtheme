...
- **Website URL:** [https://durable.co/](https://durable.co/)
- **Category:** AI
...
## 🧬 Theme DNA Summary
> **Durable design DNA: Dark void canvas, iridescent neon glow accents, prompt-first conversational UI, and live generative canvas modules.**

---

## 🔑 Signature Visual Element
Deep dark canvas (#0a0a0c) with #06b6d4 accent used exclusively on primary actions. Product screenshots or interface mockups as the primary visual element. High contrast between surface (#surface) and text creates the premium feel characteristic of Durable.

---

## 🎭 Emotional Intent
Technical precision and professional authority. The user feels Durable is built by people who understand their craft deeply. The dark aesthetic communicates focus, speed, and zero compromise on quality.

---

## 🎯 Design Principles ("Why does this look like this?")
Why Durable looks like this: Engineered to evoke machine intelligence, boundless creativity, and real-time generative wonder.
...
## ❌ Things NOT To Copy
  * Proprietary Durable brand logos
  * Exact Durable copyrighted assets
...
Your task is to analyze the user's current project / objective, and TRANSFORM / REDESIGN its entire frontend style, visual aesthetic, UX feeling, and component architecture strictly using the design system DNA of THEME #113 (Durable - https://durable.co/).
...
2. TRANSLATE DESIGN DNA (DO NOT COPY PROPRIETARY CONTENT):
   - Do NOT blindly copy placeholder copy, trademarks, or unrelated product catalog from Durable (e.g., do not insert "Durable" branding or unrelated product listings).
   - DO extract and adopt 100% of Durable's visual craft, color palette, typography hierarchy, card structures, spacing rhythm, surface depth, micro-interactions, and UX feeling.

3. ELEVATE & RESKIN EVERY COMPONENT:
   - Reskin the user's existing components (navbars, heroes, product/feature cards, buttons, filters, inputs, modals, footers) into the authentic visual language of THEME #113.
   - Example: If the user's project is an apparel store selling shirts, design a high-craft shirt catalog with Durable's signature layouts, typography scale, lighting, and button styles.

==================================================================
🧬 THEME #113 IDENTITY & EMOTIONAL BRIEF
==================================================================
- Permanent Theme ID: THEME #113
- Reference Design Source: Durable (https://durable.co/)
- Mode: dark
- Archetype / Category: AI
- Design Style: Dark Cosmic AI Interface
- Visual Personality: Durable signature design: dark cosmic ai interface, engineered with high-craft aesthetics, structured hierarchy, and platform-native ergonomics.
- Core Design DNA: Durable design DNA: Dark void canvas, iridescent neon glow accents, prompt-first conversational UI, and live generative canvas modules.

THE SIGNATURE VISUAL ELEMENT (What makes this theme unmistakably Durable):
Deep dark canvas (#0a0a0c) with #06b6d4 accent used exclusively on primary actions. Product screenshots or interface mockups as the primary visual element. High contrast between surface (#surface) and text creates the premium feel characteristic of Durable.
...
4. RE-ENGINEER every UI component (nav, hero, cards, buttons, inputs, footer) into the Durable visual language while keeping the user's real content, data, and workflows intact.
...
7. VERIFY: The output should feel unmistakably like Durable's design aesthetic applied to the user's own project domain.
