...
- **Website URL:** [https://render.com/](https://render.com/)
...
## 🧬 Theme DNA Summary
> **Render design DNA: Terminal windows, syntax highlighting, monospace metadata, hairline borders, and live developer CLI workflows.**

---

## 🔑 Signature Visual Element
Deep dark canvas (#030712) with #38bdf8 accent used exclusively on primary actions. Product screenshots or interface mockups as the primary visual element. High contrast between surface (#surface) and text creates the premium feel characteristic of Render.

---

## 🎭 Emotional Intent
Technical precision and professional authority. The user feels Render is built by people who understand their craft deeply. The dark aesthetic communicates focus, speed, and zero compromise on quality.

---

## 🎯 Design Principles ("Why does this look like this?")
Why Render looks like this: Built for instant technical comprehension, zero latency, and engineering credibility.
...
## ❌ Things NOT To Copy
  * Proprietary Render brand logos
  * Exact Render copyrighted assets
...
Your task is to analyze the user's current project / objective, and TRANSFORM / REDESIGN its entire frontend style, visual aesthetic, UX feeling, and component architecture strictly using the design system DNA of THEME #118 (Render - https://render.com/).
...
2. TRANSLATE DESIGN DNA (DO NOT COPY PROPRIETARY CONTENT):
   - Do NOT blindly copy placeholder copy, trademarks, or unrelated product catalog from Render (e.g., do not insert "Render" branding or unrelated product listings).
   - DO extract and adopt 100% of Render's visual craft, color palette, typography hierarchy, card structures, spacing rhythm, surface depth, micro-interactions, and UX feeling.

3. ELEVATE & RESKIN EVERY COMPONENT:
   - Reskin the user's existing components (navbars, heroes, product/feature cards, buttons, filters, inputs, modals, footers) into the authentic visual language of THEME #118.
   - Example: If the user's project is an apparel store selling shirts, design a high-craft shirt catalog with Render's signature layouts, typography scale, lighting, and button styles.

==================================================================
🧬 THEME #118 IDENTITY & EMOTIONAL BRIEF
==================================================================
- Permanent Theme ID: THEME #118
- Reference Design Source: Render (https://render.com/)
- Mode: dark
- Archetype / Category: Developer / Infrastructure
- Design Style: Terminal-Centric Dark DevTools
- Visual Personality: Render signature design: terminal-centric dark devtools, engineered with high-craft aesthetics, structured hierarchy, and platform-native ergonomics.
- Core Design DNA: Render design DNA: Terminal windows, syntax highlighting, monospace metadata, hairline borders, and live developer CLI workflows.

THE SIGNATURE VISUAL ELEMENT (What makes this theme unmistakably Render):
Deep dark canvas (#030712) with #38bdf8 accent used exclusively on primary actions. Product screenshots or interface mockups as the primary visual element. High contrast between surface (#surface) and text creates the premium feel characteristic of Render.
...
4. RE-ENGINEER every UI component (nav, hero, cards, buttons, inputs, footer) into the Render visual language while keeping the user's real content, data, and workflows intact.
...
7. VERIFY: The output should feel unmistakably like Render's design aesthetic applied to the user's own project domain.
