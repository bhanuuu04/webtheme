# THEME #365 --- Fear of God

- **Website URL:** [https://fearofgod.com/](https://fearofgod.com/)
...
## 🧬 Theme DNA Summary
> **Fear of God design DNA: Exquisite serif typography, expansive ivory/obsidian whitespace, 3:4 lookbook imagery, and slow graceful transitions.**

---

## 🔑 Signature Visual Element
Deep dark canvas (#0c0c0c) with #d4af37 accent used exclusively on primary actions. Product screenshots or interface mockups as the primary visual element. High contrast between surface (#surface) and text creates the premium feel characteristic of Fear of God.

---

## 🎭 Emotional Intent
Technical precision and professional authority. The user feels Fear of God is built by people who understand their craft deeply. The dark aesthetic communicates focus, speed, and zero compromise on quality.

---

## 🎯 Design Principles ("Why does this look like this?")
Why Fear of God looks like this: Engineered to evoke timeless elegance, craftsmanship, exclusivity, and quiet luxury.
...
- Hospitality & resorts
- Fragrance & beauty
- Fear of God-inspired applications
...
## ❌ Things NOT To Copy
  * Proprietary Fear of God brand logos
  * Exact Fear of God copyrighted assets
...
Your task is to analyze the user's current project / objective, and TRANSFORM / REDESIGN its entire frontend style, visual aesthetic, UX feeling, and component architecture strictly using the design system DNA of THEME #365 (Fear of God - https://fearofgod.com/).
...
2. TRANSLATE DESIGN DNA (DO NOT COPY PROPRIETARY CONTENT):
   - Do NOT blindly copy placeholder copy, trademarks, or unrelated product catalog from Fear of God (e.g., do not insert "Fear of God" branding or unrelated product listings).
   - DO extract and adopt 100% of Fear of God's visual craft, color palette, typography hierarchy, card structures, spacing rhythm, surface depth, micro-interactions, and UX feeling.

3. ELEVATE & RESKIN EVERY COMPONENT:
   - Reskin the user's existing components (navbars, heroes, product/feature cards, buttons, filters, inputs, modals, footers) into the authentic visual language of THEME #365.
   - Example: If the user's project is an apparel store selling shirts, design a high-craft shirt catalog with Fear of God's signature layouts, typography scale, lighting, and button styles.

==================================================================
🧬 THEME #365 IDENTITY & EMOTIONAL BRIEF
==================================================================
- Permanent Theme ID: THEME #365
- Reference Design Source: Fear of God (https://fearofgod.com/)
- Mode: dark
- Archetype / Category: Luxury / Fashion
- Design Style: High-End Parisian Haute Couture
- Visual Personality: Fear of God signature design: high-end parisian haute couture, engineered with high-craft aesthetics, structured hierarchy, and platform-native ergonomics.
- Core Design DNA: Fear of God design DNA: Exquisite serif typography, expansive ivory/obsidian whitespace, 3:4 lookbook imagery, and slow graceful transitions.

THE SIGNATURE VISUAL ELEMENT (What makes this theme unmistakably Fear of God):
Deep dark canvas (#0c0c0c) with #d4af37 accent used exclusively on primary actions. Product screenshots or interface mockups as the primary visual element. High contrast between surface (#surface) and text creates the premium feel characteristic of Fear of God.
...
4. RE-ENGINEER every UI component (nav, hero, cards, buttons, inputs, footer) into the Fear of God visual language while keeping the user's real content, data, and workflows intact.
...
7. VERIFY: The output should feel unmistakably like Fear of God's design aesthetic applied to the user's own project domain.
