# THEME #086 --- Together AI

- **Website URL:** [https://www.together.ai/](https://www.together.ai/)
- **Category:** AI
...
## 🧬 Theme DNA Summary
> **Together AI design DNA: Dark void canvas, iridescent neon glow accents, prompt-first conversational UI, and live generative canvas modules.**

---

## 🔑 Signature Visual Element
Deep dark canvas (#0a0a0c) with #06b6d4 accent used exclusively on primary actions. Product screenshots or interface mockups as the primary visual element. High contrast between surface (#surface) and text creates the premium feel characteristic of Together AI.

---

## 🎭 Emotional Intent
Technical precision and professional authority. The user feels Together AI is built by people who understand their craft deeply. The dark aesthetic communicates focus, speed, and zero compromise on quality.

---

## 🎯 Design Principles ("Why does this look like this?")
Why Together AI looks like this: Engineered to evoke machine intelligence, boundless creativity, and real-time generative wonder.
...
- Model playgrounds
- Together AI-inspired applications
- AI platforms
...
## ❌ Things NOT To Copy
  * Proprietary Together AI brand logos
  * Exact Together AI copyrighted assets
...
Your task is to analyze the user's current project / objective, and TRANSFORM / REDESIGN its entire frontend style, visual aesthetic, UX feeling, and component architecture strictly using the design system DNA of THEME #086 (Together AI - https://www.together.ai/).
...
2. TRANSLATE DESIGN DNA (DO NOT COPY PROPRIETARY CONTENT):
   - Do NOT blindly copy placeholder copy, trademarks, or unrelated product catalog from Together AI (e.g., do not insert "Together AI" branding or unrelated product listings).
   - DO extract and adopt 100% of Together AI's visual craft, color palette, typography hierarchy, card structures, spacing rhythm, surface depth, micro-interactions, and UX feeling.

3. ELEVATE & RESKIN EVERY COMPONENT:
   - Reskin the user's existing components (navbars, heroes, product/feature cards, buttons, filters, inputs, modals, footers) into the authentic visual language of THEME #086.
   - Example: If the user's project is an apparel store selling shirts, design a high-craft shirt catalog with Together AI's signature layouts, typography scale, lighting, and button styles.

==================================================================
🧬 THEME #086 IDENTITY & EMOTIONAL BRIEF
==================================================================
- Permanent Theme ID: THEME #086
- Reference Design Source: Together AI (https://www.together.ai/)
- Mode: dark
- Archetype / Category: AI
- Design Style: Minimalist Prompt-First Canvas
- Visual Personality: Together AI signature design: minimalist prompt-first canvas, engineered with high-craft aesthetics, structured hierarchy, and platform-native ergonomics.
- Core Design DNA: Together AI design DNA: Dark void canvas, iridescent neon glow accents, prompt-first conversational UI, and live generative canvas modules.

THE SIGNATURE VISUAL ELEMENT (What makes this theme unmistakably Together AI):
Deep dark canvas (#0a0a0c) with #06b6d4 accent used exclusively on primary actions. Product screenshots or interface mockups as the primary visual element. High contrast between surface (#surface) and text creates the premium feel characteristic of Together AI.
...
#06b6d4  ->  primary CTA buttons, links on hover, focus rings, selected states, brand accents
#f4f4f5  ->  all headings (H1-H3), body text, primary UI labels
...
colors: { bg: '#0a0a0c', surface: '#18181b', accent: '#06b6d4', primary: '#f4f4f5', muted: '#71717a' }
...
4. RE-ENGINEER every UI component (nav, hero, cards, buttons, inputs, footer) into the Together AI visual language while keeping the user's real content, data, and workflows intact.
...
7. VERIFY: The output should feel unmistakably like Together AI's design aesthetic applied to the user's own project domain.
