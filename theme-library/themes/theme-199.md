# THEME #199 --- Ramp Travel

- **Website URL:** [https://ramp.com/travel](https://ramp.com/travel)
...
## 🧬 Theme DNA Summary
> **Ramp Travel design DNA: High-trust typography, dynamic financial metric counters, virtual debit card mockups, and regulatory rigor.**

---

## 🔑 Signature Visual Element
Deep dark canvas (#0a192f) with #00e599 accent used exclusively on primary actions. Product screenshots or interface mockups as the primary visual element. High contrast between surface (#surface) and text creates the premium feel characteristic of Ramp Travel.

---

## 🎭 Emotional Intent
Technical precision and professional authority. The user feels Ramp Travel is built by people who understand their craft deeply. The dark aesthetic communicates focus, speed, and zero compromise on quality.

---

## 🎯 Design Principles ("Why does this look like this?")
Why Ramp Travel looks like this: Engineered to project absolute security, frictionless capital flow, and financial empowerment.
...
- Accounting SaaS
- Ramp Travel-inspired applications
...
## ❌ Things NOT To Copy
  * Proprietary Ramp Travel brand logos
  * Exact Ramp Travel copyrighted assets
...
Your task is to analyze the user's current project / objective, and TRANSFORM / REDESIGN its entire frontend style, visual aesthetic, UX feeling, and component architecture strictly using the design system DNA of THEME #199 (Ramp Travel - https://ramp.com/travel).
...
2. TRANSLATE DESIGN DNA (DO NOT COPY PROPRIETARY CONTENT):
   - Do NOT blindly copy placeholder copy, trademarks, or unrelated product catalog from Ramp Travel (e.g., do not insert "Ramp Travel" branding or unrelated product listings).
   - DO extract and adopt 100% of Ramp Travel's visual craft, color palette, typography hierarchy, card structures, spacing rhythm, surface depth, micro-interactions, and UX feeling.

3. ELEVATE & RESKIN EVERY COMPONENT:
   - Reskin the user's existing components (navbars, heroes, product/feature cards, buttons, filters, inputs, modals, footers) into the authentic visual language of THEME #199.
   - Example: If the user's project is an apparel store selling shirts, design a high-craft shirt catalog with Ramp Travel's signature layouts, typography scale, lighting, and button styles.

==================================================================
🧬 THEME #199 IDENTITY & EMOTIONAL BRIEF
==================================================================
- Permanent Theme ID: THEME #199
- Reference Design Source: Ramp Travel (https://ramp.com/travel)
- Mode: dark
- Archetype / Category: Fintech / Finance
- Design Style: Precision Quantitative Dashboard
- Visual Personality: Ramp Travel signature design: precision quantitative dashboard, engineered with high-craft aesthetics, structured hierarchy, and platform-native ergonomics.
- Core Design DNA: Ramp Travel design DNA: High-trust typography, dynamic financial metric counters, virtual debit card mockups, and regulatory rigor.

THE SIGNATURE VISUAL ELEMENT (What makes this theme unmistakably Ramp Travel):
Deep dark canvas (#0a192f) with #00e599 accent used exclusively on primary actions. Product screenshots or interface mockups as the primary visual element. High contrast between surface (#surface) and text creates the premium feel characteristic of Ramp Travel.
...
4. RE-ENGINEER every UI component (nav, hero, cards, buttons, inputs, footer) into the Ramp Travel visual language while keeping the user's real content, data, and workflows intact.
...
7. VERIFY: The output should feel unmistakably like Ramp Travel's design aesthetic applied to the user's own project domain.
