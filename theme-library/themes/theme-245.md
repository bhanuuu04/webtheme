# THEME #245 --- Experiments with Google

- **Website URL:** [https://experiments.withgoogle.com/](https://experiments.withgoogle.com/)
...
## 🧬 Theme DNA Summary
> **Experiments with Google design DNA: Full-bleed WebGL 3D canvas, corner HUD interface layout, kinetic typography, magnetic cursor, and spatial physics.**

---

## 🔑 Signature Visual Element
Deep dark canvas (#000000) with #ff3366 accent used exclusively on primary actions. Product screenshots or interface mockups as the primary visual element. High contrast between surface (#surface) and text creates the premium feel characteristic of Experiments with Google.

---

## 🎭 Emotional Intent
Technical precision and professional authority. The user feels Experiments with Google is built by people who understand their craft deeply. The dark aesthetic communicates focus, speed, and zero compromise on quality.

---

## 🎯 Design Principles ("Why does this look like this?")
Why Experiments with Google looks like this: Engineered to deliver unforgettable tactile immersion, technological awe, and cutting-edge craft.
...
- Luxury concepts
- Experiments with Google-inspired applications
...
## ❌ Things NOT To Copy
  * Proprietary Experiments with Google brand logos
  * Exact Experiments with Google copyrighted assets
...
Your task is to analyze the user's current project / objective, and TRANSFORM / REDESIGN its entire frontend style, visual aesthetic, UX feeling, and component architecture strictly using the design system DNA of THEME #245 (Experiments with Google - https://experiments.withgoogle.com/).
...
2. TRANSLATE DESIGN DNA (DO NOT COPY PROPRIETARY CONTENT):
   - Do NOT blindly copy placeholder copy, trademarks, or unrelated product catalog from Experiments with Google (e.g., do not insert "Experiments with Google" branding or unrelated product listings).
   - DO extract and adopt 100% of Experiments with Google's visual craft, color palette, typography hierarchy, card structures, spacing rhythm, surface depth, micro-interactions, and UX feeling.

3. ELEVATE & RESKIN EVERY COMPONENT:
   - Reskin the user's existing components (navbars, heroes, product/feature cards, buttons, filters, inputs, modals, footers) into the authentic visual language of THEME #245.
   - Example: If the user's project is an apparel store selling shirts, design a high-craft shirt catalog with Experiments with Google's signature layouts, typography scale, lighting, and button styles.

==================================================================
🧬 THEME #245 IDENTITY & EMOTIONAL BRIEF
==================================================================
- Permanent Theme ID: THEME #245
- Reference Design Source: Experiments with Google (https://experiments.withgoogle.com/)
- Mode: dark
- Archetype / Category: 3D / WebGL / Immersive
- Design Style: Interactive WebGL Spatial Experience
- Visual Personality: Experiments with Google signature design: interactive webgl spatial experience, engineered with high-craft aesthetics, structured hierarchy, and platform-native ergonomics.
- Core Design DNA: Experiments with Google design DNA: Full-bleed WebGL 3D canvas, corner HUD interface layout, kinetic typography, magnetic cursor, and spatial physics.

THE SIGNATURE VISUAL ELEMENT (What makes this theme unmistakably Experiments with Google):
Deep dark canvas (#000000) with #ff3366 accent used exclusively on primary actions. Product screenshots or interface mockups as the primary visual element. High contrast between surface (#surface) and text creates the premium feel characteristic of Experiments with Google.
...
4. RE-ENGINEER every UI component (nav, hero, cards, buttons, inputs, footer) into the Experiments with Google visual language while keeping the user's real content, data, and workflows intact.
...
7. VERIFY: The output should feel unmistakably like Experiments with Google's design aesthetic applied to the user's own project domain.
