...
- **Website URL:** [https://readymag.com/](https://readymag.com/)
...
## 🧬 Theme DNA Summary
> **Readymag design DNA: Large typography, generous whitespace, monochrome palette, subtle borders, restrained motion, asymmetric hero composition and strong product-focused visual hierarchy.**

---

## 🔑 Signature Visual Element
Deep dark canvas (#0f172a) with #10b981 accent used exclusively on primary actions. Product screenshots or interface mockups as the primary visual element. High contrast between surface (#surface) and text creates the premium feel characteristic of Readymag.

---

## 🎭 Emotional Intent
Technical precision and professional authority. The user feels Readymag is built by people who understand their craft deeply. The dark aesthetic communicates focus, speed, and zero compromise on quality.

---

## 🎯 Design Principles ("Why does this look like this?")
Why Readymag looks like this: Built to communicate speed, craft, and keyboard-first productivity by removing clutter and focusing on high contrast, micro-details, and crisp dark backgrounds.
...
- High-craft B2B SaaS
- Command bar tools
- Readymag-inspired applications
...
## ❌ Things NOT To Copy
  * Proprietary Readymag brand logos
  * Exact Readymag copyrighted assets
...
Your task is to analyze the user's current project / objective, and TRANSFORM / REDESIGN its entire frontend style, visual aesthetic, UX feeling, and component architecture strictly using the design system DNA of THEME #027 (Readymag - https://readymag.com/).
...
2. TRANSLATE DESIGN DNA (DO NOT COPY PROPRIETARY CONTENT):
   - Do NOT blindly copy placeholder copy, trademarks, or unrelated product catalog from Readymag (e.g., do not insert "Readymag" branding or unrelated product listings).
   - DO extract and adopt 100% of Readymag's visual craft, color palette, typography hierarchy, card structures, spacing rhythm, surface depth, micro-interactions, and UX feeling.

3. ELEVATE & RESKIN EVERY COMPONENT:
   - Reskin the user's existing components (navbars, heroes, product/feature cards, buttons, filters, inputs, modals, footers) into the authentic visual language of THEME #027.
   - Example: If the user's project is an apparel store selling shirts, design a high-craft shirt catalog with Readymag's signature layouts, typography scale, lighting, and button styles.

==================================================================
🧬 THEME #027 IDENTITY & EMOTIONAL BRIEF
==================================================================
- Permanent Theme ID: THEME #027
- Reference Design Source: Readymag (https://readymag.com/)
- Mode: dark
- Archetype / Category: SaaS / Product
- Design Style: High-Density Productivity Workspace
- Visual Personality: Readymag signature design: high-density productivity workspace, engineered with high-craft aesthetics, structured hierarchy, and platform-native ergonomics.
- Core Design DNA: Readymag design DNA: Large typography, generous whitespace, monochrome palette, subtle borders, restrained motion, asymmetric hero composition and strong product-focused visual hierarchy.

THE SIGNATURE VISUAL ELEMENT (What makes this theme unmistakably Readymag):
Deep dark canvas (#0f172a) with #10b981 accent used exclusively on primary actions. Product screenshots or interface mockups as the primary visual element. High contrast between surface (#surface) and text creates the premium feel characteristic of Readymag.
...
4. RE-ENGINEER every UI component (nav, hero, cards, buttons, inputs, footer) into the Readymag visual language while keeping the user's real content, data, and workflows intact.
...
7. VERIFY: The output should feel unmistakably like Readymag's design aesthetic applied to the user's own project domain.
