# THEME #068 --- Notion Calendar

- **Website URL:** [https://www.notion.com/product/calendar/](https://www.notion.com/product/calendar/)
...
## 🧬 Theme DNA Summary
> **Notion Calendar design DNA: Large typography, generous whitespace, monochrome palette, subtle borders, restrained motion, asymmetric hero composition and strong product-focused visual hierarchy.**
...
Why Notion Calendar looks like this: Built to communicate speed, craft, and keyboard-first productivity by removing clutter and focusing on high contrast, micro-details, and crisp dark backgrounds.
...
- High-craft B2B SaaS
- Command bar tools
- Notion Calendar-inspired applications
...
## ❌ Things NOT To Copy
  * Proprietary Notion Calendar brand logos
  * Exact Notion Calendar copyrighted assets
...
Your task is to analyze the user's current project / objective, and TRANSFORM / REDESIGN its entire frontend style, visual aesthetic, UX feeling, and component architecture strictly using the design system DNA of THEME #068 (Notion Calendar - https://www.notion.com/product/calendar/).
...
2. TRANSLATE DESIGN DNA (DO NOT COPY PROPRIETARY CONTENT):
   - Do NOT blindly copy placeholder copy, trademarks, or unrelated product catalog from Notion Calendar (e.g., do not insert "Notion Calendar" branding or unrelated product listings).
   - DO extract and adopt 100% of Notion Calendar's visual craft, color palette, typography hierarchy, card structures, spacing rhythm, surface depth, micro-interactions, and UX feeling.

3. ELEVATE & RESKIN EVERY COMPONENT:
   - Reskin the user's existing components (navbars, heroes, product/feature cards, buttons, filters, inputs, modals, footers) into the authentic visual language of THEME #068.
   - Example: If the user's project is an apparel store selling shirts, design a high-craft shirt catalog with Notion Calendar's signature layouts, typography scale, lighting, and button styles.

==================================================================
🧬 THEME #068 IDENTITY & EMOTIONAL BRIEF
==================================================================
- Permanent Theme ID: THEME #068
- Reference Design Source: Notion Calendar (https://www.notion.com/product/calendar/)
- Mode: adaptive
- Archetype / Category: SaaS / Product
- Design Style: Vibrant Multi-Layered Product Hub
- Visual Personality: Notion Calendar signature design: vibrant multi-layered product hub, engineered with high-craft aesthetics, structured hierarchy, and platform-native ergonomics.
- Core Design DNA: Notion Calendar design DNA: Large typography, generous whitespace, monochrome palette, subtle borders, restrained motion, asymmetric hero composition and strong product-focused visual hierarchy.

THE SIGNATURE VISUAL ELEMENT (What makes this theme unmistakably Notion Calendar):
Clean blank-canvas aesthetic: default serif-less type on pure white, sidebar tree navigation, block-based content modular system. The page itself IS the product — no decorative chrome, zero visual clutter.
...
4. RE-ENGINEER every UI component (nav, hero, cards, buttons, inputs, footer) into the Notion Calendar visual language while keeping the user's real content, data, and workflows intact.
...
7. VERIFY: The output should feel unmistakably like Notion Calendar's design aesthetic applied to the user's own project domain.
