...
- **Website URL:** [https://www.lelabofragrances.com/](https://www.lelabofragrances.com/)
...
## 🧬 Theme DNA Summary
> **Le Labo design DNA: Exquisite serif typography, expansive ivory/obsidian whitespace, 3:4 lookbook imagery, and slow graceful transitions.**

---

## 🔑 Signature Visual Element
Clean white editorial canvas with #1a1818 as the single brand accent color. Large display typography and generous whitespace communicate the premium quality of Le Labo. Product screenshots or lifestyle imagery on clean white/off-white backgrounds.

---

## 🎭 Emotional Intent
Clarity and trustworthiness. The user feels confident that Le Labo is the right choice — professional, accessible, and purpose-built for their needs. The clean light design removes friction and communicates reliability.

---

## 🎯 Design Principles ("Why does this look like this?")
Why Le Labo looks like this: Engineered to evoke timeless elegance, craftsmanship, exclusivity, and quiet luxury.
...
## ❌ Things NOT To Copy
  * Proprietary Le Labo brand logos
  * Exact Le Labo copyrighted assets
...
Your task is to analyze the user's current project / objective, and TRANSFORM / REDESIGN its entire frontend style, visual aesthetic, UX feeling, and component architecture strictly using the design system DNA of THEME #358 (Le Labo - https://www.lelabofragrances.com/).
...
2. TRANSLATE DESIGN DNA (DO NOT COPY PROPRIETARY CONTENT):
   - Do NOT blindly copy placeholder copy, trademarks, or unrelated product catalog from Le Labo (e.g., do not insert "Le Labo" branding or unrelated product listings).
   - DO extract and adopt 100% of Le Labo's visual craft, color palette, typography hierarchy, card structures, spacing rhythm, surface depth, micro-interactions, and UX feeling.

3. ELEVATE & RESKIN EVERY COMPONENT:
   - Reskin the user's existing components (navbars, heroes, product/feature cards, buttons, filters, inputs, modals, footers) into the authentic visual language of THEME #358.
   - Example: If the user's project is an apparel store selling shirts, design a high-craft shirt catalog with Le Labo's signature layouts, typography scale, lighting, and button styles.

==================================================================
🧬 THEME #358 IDENTITY & EMOTIONAL BRIEF
==================================================================
- Permanent Theme ID: THEME #358
- Reference Design Source: Le Labo (https://www.lelabofragrances.com/)
- Mode: light
- Archetype / Category: Luxury / Fashion
- Design Style: Minimalist Swiss Editorial
- Visual Personality: Le Labo signature design: minimalist swiss editorial, engineered with high-craft aesthetics, structured hierarchy, and platform-native ergonomics.
- Core Design DNA: Le Labo design DNA: Exquisite serif typography, expansive ivory/obsidian whitespace, 3:4 lookbook imagery, and slow graceful transitions.

THE SIGNATURE VISUAL ELEMENT (What makes this theme unmistakably Le Labo):
Clean white editorial canvas with #1a1818 as the single brand accent color. Large display typography and generous whitespace communicate the premium quality of Le Labo. Product screenshots or lifestyle imagery on clean white/off-white backgrounds.
...
4. RE-ENGINEER every UI component (nav, hero, cards, buttons, inputs, footer) into the Le Labo visual language while keeping the user's real content, data, and workflows intact.
...
7. VERIFY: The output should feel unmistakably like Le Labo's design aesthetic applied to the user's own project domain.
