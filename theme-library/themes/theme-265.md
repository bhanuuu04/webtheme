# THEME #265 --- Minimal Gallery

- **Website URL:** [https://minimal.gallery/](https://minimal.gallery/)
- **Category:** Motion / Interaction
- **Design Style:** Kinetic Micro-Interaction Studio
- **Mode:** dark
- **Tags:** `motion-interaction`, `dark`, `minimal`, `motion`

---

## 🧬 Theme DNA Summary
> **Minimal Gallery design DNA: Kinetic spring physics, interactive dragging elements, playful typography transforms, and scroll-pinned storytelling.**

---

## 🔑 Signature Visual Element
Deep dark canvas (#0f0f11) with #ff5c00 accent used exclusively on primary actions. Product screenshots or interface mockups as the primary visual element. High contrast between surface (#surface) and text creates the premium feel characteristic of Minimal Gallery.

---

## 🎭 Emotional Intent
Technical precision and professional authority. The user feels Minimal Gallery is built by people who understand their craft deeply. The dark aesthetic communicates focus, speed, and zero compromise on quality.

---

## 🎯 Design Principles ("Why does this look like this?")
Why Minimal Gallery looks like this: Engineered to reward user curiosity, delight through micro-interactions, and make software feel alive.
...
- Mobile apps
- Consumer portfolios
- Minimal Gallery-inspired applications
...
## ❌ Things NOT To Copy
  * Proprietary Minimal Gallery brand logos
  * Exact Minimal Gallery copyrighted assets
...
Your task is to analyze the user's current project / objective, and TRANSFORM / REDESIGN its entire frontend style, visual aesthetic, UX feeling, and component architecture strictly using the design system DNA of THEME #265 (Minimal Gallery - https://minimal.gallery/).
...
2. TRANSLATE DESIGN DNA (DO NOT COPY PROPRIETARY CONTENT):
   - Do NOT blindly copy placeholder copy, trademarks, or unrelated product catalog from Minimal Gallery (e.g., do not insert "Minimal Gallery" branding or unrelated product listings).
   - DO extract and adopt 100% of Minimal Gallery's visual craft, color palette, typography hierarchy, card structures, spacing rhythm, surface depth, micro-interactions, and UX feeling.

3. ELEVATE & RESKIN EVERY COMPONENT:
   - Reskin the user's existing components (navbars, heroes, product/feature cards, buttons, filters, inputs, modals, footers) into the authentic visual language of THEME #265.
   - Example: If the user's project is an apparel store selling shirts, design a high-craft shirt catalog with Minimal Gallery's signature layouts, typography scale, lighting, and button styles.

==================================================================
🧬 THEME #265 IDENTITY & EMOTIONAL BRIEF
==================================================================
- Permanent Theme ID: THEME #265
- Reference Design Source: Minimal Gallery (https://minimal.gallery/)
- Mode: dark
- Archetype / Category: Motion / Interaction
- Design Style: Kinetic Micro-Interaction Studio
- Visual Personality: Minimal Gallery signature design: kinetic micro-interaction studio, engineered with high-craft aesthetics, structured hierarchy, and platform-native ergonomics.
- Core Design DNA: Minimal Gallery design DNA: Kinetic spring physics, interactive dragging elements, playful typography transforms, and scroll-pinned storytelling.

THE SIGNATURE VISUAL ELEMENT (What makes this theme unmistakably Minimal Gallery):
Deep dark canvas (#0f0f11) with #ff5c00 accent used exclusively on primary actions. Product screenshots or interface mockups as the primary visual element. High contrast between surface (#surface) and text creates the premium feel characteristic of Minimal Gallery.
...
4. RE-ENGINEER every UI component (nav, hero, cards, buttons, inputs, footer) into the Minimal Gallery visual language while keeping the user's real content, data, and workflows intact.
...
7. VERIFY: The output should feel unmistakably like Minimal Gallery's design aesthetic applied to the user's own project domain.
