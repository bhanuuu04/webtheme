...
- **Website URL:** [https://www.nvidia.com/en-us/ai/](https://www.nvidia.com/en-us/ai/)
- **Category:** AI
...
## 🧬 Theme DNA Summary
> **NVIDIA AI design DNA: Dark void canvas, iridescent neon glow accents, prompt-first conversational UI, and live generative canvas modules.**

---

## 🔑 Signature Visual Element
Deep dark canvas (#050505) with #a855f7 accent used exclusively on primary actions. Product screenshots or interface mockups as the primary visual element. High contrast between surface (#surface) and text creates the premium feel characteristic of NVIDIA AI.

---

## 🎭 Emotional Intent
Technical precision and professional authority. The user feels NVIDIA AI is built by people who understand their craft deeply. The dark aesthetic communicates focus, speed, and zero compromise on quality.

---

## 🎯 Design Principles ("Why does this look like this?")
Why NVIDIA AI looks like this: Engineered to evoke machine intelligence, boundless creativity, and real-time generative wonder.
...
- Model playgrounds
- NVIDIA AI-inspired applications
- AI platforms
...
## ❌ Things NOT To Copy
  * Proprietary NVIDIA AI brand logos
  * Exact NVIDIA AI copyrighted assets
...
Your task is to analyze the user's current project / objective, and TRANSFORM / REDESIGN its entire frontend style, visual aesthetic, UX feeling, and component architecture strictly using the design system DNA of THEME #091 (NVIDIA AI - https://www.nvidia.com/en-us/ai/).
...
2. TRANSLATE DESIGN DNA (DO NOT COPY PROPRIETARY CONTENT):
   - Do NOT blindly copy placeholder copy, trademarks, or unrelated product catalog from NVIDIA AI (e.g., do not insert "NVIDIA AI" branding or unrelated product listings).
   - DO extract and adopt 100% of NVIDIA AI's visual craft, color palette, typography hierarchy, card structures, spacing rhythm, surface depth, micro-interactions, and UX feeling.

3. ELEVATE & RESKIN EVERY COMPONENT:
   - Reskin the user's existing components (navbars, heroes, product/feature cards, buttons, filters, inputs, modals, footers) into the authentic visual language of THEME #091.
   - Example: If the user's project is an apparel store selling shirts, design a high-craft shirt catalog with NVIDIA AI's signature layouts, typography scale, lighting, and button styles.

==================================================================
🧬 THEME #091 IDENTITY & EMOTIONAL BRIEF
==================================================================
- Permanent Theme ID: THEME #091
- Reference Design Source: NVIDIA AI (https://www.nvidia.com/en-us/ai/)
- Mode: dark
- Archetype / Category: AI
- Design Style: Glow-Infused Neural Studio
- Visual Personality: NVIDIA AI signature design: glow-infused neural studio, engineered with high-craft aesthetics, structured hierarchy, and platform-native ergonomics.
- Core Design DNA: NVIDIA AI design DNA: Dark void canvas, iridescent neon glow accents, prompt-first conversational UI, and live generative canvas modules.

THE SIGNATURE VISUAL ELEMENT (What makes this theme unmistakably NVIDIA AI):
Deep dark canvas (#050505) with #a855f7 accent used exclusively on primary actions. Product screenshots or interface mockups as the primary visual element. High contrast between surface (#surface) and text creates the premium feel characteristic of NVIDIA AI.
...
colors: { bg: '#050505', surface: '#121216', accent: '#a855f7', primary: '#ffffff', muted: '#a1a1aa' }
...
4. RE-ENGINEER every UI component (nav, hero, cards, buttons, inputs, footer) into the NVIDIA AI visual language while keeping the user's real content, data, and workflows intact.
...
7. VERIFY: The output should feel unmistakably like NVIDIA AI's design aesthetic applied to the user's own project domain.
