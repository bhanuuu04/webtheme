...
- **Website URL:** [https://ui.shadcn.com/](https://ui.shadcn.com/)
...
## 🧬 Theme DNA Summary
> **shadcn/ui design DNA: Terminal windows, syntax highlighting, monospace metadata, hairline borders, and live developer CLI workflows.**

---

## 🔑 Signature Visual Element
Deep dark canvas (#030712) with #38bdf8 accent used exclusively on primary actions. Product screenshots or interface mockups as the primary visual element. High contrast between surface (#surface) and text creates the premium feel characteristic of shadcn/ui.

---

## 🎭 Emotional Intent
Technical precision and professional authority. The user feels shadcn/ui is built by people who understand their craft deeply. The dark aesthetic communicates focus, speed, and zero compromise on quality.

---

## 🎯 Design Principles ("Why does this look like this?")
Why shadcn/ui looks like this: Built for instant technical comprehension, zero latency, and engineering credibility.
...
- Developer platforms
- CI/CD tools
- shadcn/ui-inspired applications
...
## ❌ Things NOT To Copy
  * Proprietary shadcn/ui brand logos
  * Exact shadcn/ui copyrighted assets
...
Your task is to analyze the user's current project / objective, and TRANSFORM / REDESIGN its entire frontend style, visual aesthetic, UX feeling, and component architecture strictly using the design system DNA of THEME #142 (shadcn/ui - https://ui.shadcn.com/).
...
2. TRANSLATE DESIGN DNA (DO NOT COPY PROPRIETARY CONTENT):
   - Do NOT blindly copy placeholder copy, trademarks, or unrelated product catalog from shadcn/ui (e.g., do not insert "shadcn/ui" branding or unrelated product listings).
   - DO extract and adopt 100% of shadcn/ui's visual craft, color palette, typography hierarchy, card structures, spacing rhythm, surface depth, micro-interactions, and UX feeling.

3. ELEVATE & RESKIN EVERY COMPONENT:
   - Reskin the user's existing components (navbars, heroes, product/feature cards, buttons, filters, inputs, modals, footers) into the authentic visual language of THEME #142.
   - Example: If the user's project is an apparel store selling shirts, design a high-craft shirt catalog with shadcn/ui's signature layouts, typography scale, lighting, and button styles.

==================================================================
🧬 THEME #142 IDENTITY & EMOTIONAL BRIEF
==================================================================
- Permanent Theme ID: THEME #142
- Reference Design Source: shadcn/ui (https://ui.shadcn.com/)
- Mode: dark
- Archetype / Category: Developer / Infrastructure
- Design Style: Terminal-Centric Dark DevTools
- Visual Personality: shadcn/ui signature design: terminal-centric dark devtools, engineered with high-craft aesthetics, structured hierarchy, and platform-native ergonomics.
- Core Design DNA: shadcn/ui design DNA: Terminal windows, syntax highlighting, monospace metadata, hairline borders, and live developer CLI workflows.

THE SIGNATURE VISUAL ELEMENT (What makes this theme unmistakably shadcn/ui):
Deep dark canvas (#030712) with #38bdf8 accent used exclusively on primary actions. Product screenshots or interface mockups as the primary visual element. High contrast between surface (#surface) and text creates the premium feel characteristic of shadcn/ui.
...
4. RE-ENGINEER every UI component (nav, hero, cards, buttons, inputs, footer) into the shadcn/ui visual language while keeping the user's real content, data, and workflows intact.
...
7. VERIFY: The output should feel unmistakably like shadcn/ui's design aesthetic applied to the user's own project domain.
