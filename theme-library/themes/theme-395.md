...
- **Website URL:** [https://lucidmotors.com/](https://lucidmotors.com/)
...
## 🧬 Theme DNA Summary
> **Lucid design DNA: Matte carbon textures, telemetry spec dials, 360 configurator controls, chamfered components, and industrial precision.**

---

## 🔑 Signature Visual Element
Deep dark canvas (#0a0a0c) with #e11d48 accent used exclusively on primary actions. Product screenshots or interface mockups as the primary visual element. High contrast between surface (#surface) and text creates the premium feel characteristic of Lucid.

---

## 🎭 Emotional Intent
Technical precision and professional authority. The user feels Lucid is built by people who understand their craft deeply. The dark aesthetic communicates focus, speed, and zero compromise on quality.

---

## 🎯 Design Principles ("Why does this look like this?")
Why Lucid looks like this: Engineered to communicate sheer performance, mechanical mastery, aerodynamic speed, and premium craft.
...
## ❌ Things NOT To Copy
  * Proprietary Lucid brand logos
  * Exact Lucid copyrighted assets
...
Your task is to analyze the user's current project / objective, and TRANSFORM / REDESIGN its entire frontend style, visual aesthetic, UX feeling, and component architecture strictly using the design system DNA of THEME #395 (Lucid - https://lucidmotors.com/).
...
2. TRANSLATE DESIGN DNA (DO NOT COPY PROPRIETARY CONTENT):
   - Do NOT blindly copy placeholder copy, trademarks, or unrelated product catalog from Lucid (e.g., do not insert "Lucid" branding or unrelated product listings).
   - DO extract and adopt 100% of Lucid's visual craft, color palette, typography hierarchy, card structures, spacing rhythm, surface depth, micro-interactions, and UX feeling.

3. ELEVATE & RESKIN EVERY COMPONENT:
   - Reskin the user's existing components (navbars, heroes, product/feature cards, buttons, filters, inputs, modals, footers) into the authentic visual language of THEME #395.
   - Example: If the user's project is an apparel store selling shirts, design a high-craft shirt catalog with Lucid's signature layouts, typography scale, lighting, and button styles.

==================================================================
🧬 THEME #395 IDENTITY & EMOTIONAL BRIEF
==================================================================
- Permanent Theme ID: THEME #395
- Reference Design Source: Lucid (https://lucidmotors.com/)
- Mode: dark
- Archetype / Category: Automotive / Product
- Design Style: Industrial Precision Hardware
- Visual Personality: Lucid signature design: industrial precision hardware, engineered with high-craft aesthetics, structured hierarchy, and platform-native ergonomics.
- Core Design DNA: Lucid design DNA: Matte carbon textures, telemetry spec dials, 360 configurator controls, chamfered components, and industrial precision.

THE SIGNATURE VISUAL ELEMENT (What makes this theme unmistakably Lucid):
Deep dark canvas (#0a0a0c) with #e11d48 accent used exclusively on primary actions. Product screenshots or interface mockups as the primary visual element. High contrast between surface (#surface) and text creates the premium feel characteristic of Lucid.
...
4. RE-ENGINEER every UI component (nav, hero, cards, buttons, inputs, footer) into the Lucid visual language while keeping the user's real content, data, and workflows intact.
...
7. VERIFY: The output should feel unmistakably like Lucid's design aesthetic applied to the user's own project domain.
