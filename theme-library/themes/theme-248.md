# THEME #248 --- Bruno's Experiments

- **Website URL:** [https://bruno-simon.com/](https://bruno-simon.com/)
...
## 🧬 Theme DNA Summary
> **Bruno's Experiments design DNA: Full-bleed WebGL 3D canvas, corner HUD interface layout, kinetic typography, magnetic cursor, and spatial physics.**

---

## 🔑 Signature Visual Element
Deep dark canvas (#080810) with #6366f1 accent used exclusively on primary actions. Product screenshots or interface mockups as the primary visual element. High contrast between surface (#surface) and text creates the premium feel characteristic of Bruno's Experiments.

---

## 🎭 Emotional Intent
Technical precision and professional authority. The user feels Bruno's Experiments is built by people who understand their craft deeply. The dark aesthetic communicates focus, speed, and zero compromise on quality.

---

## 🎯 Design Principles ("Why does this look like this?")
Why Bruno's Experiments looks like this: Engineered to deliver unforgettable tactile immersion, technological awe, and cutting-edge craft.
...
- Luxury concepts
- Bruno's Experiments-inspired applications
...
## ❌ Things NOT To Copy
  * Proprietary Bruno's Experiments brand logos
  * Exact Bruno's Experiments copyrighted assets
...
Your task is to analyze the user's current project / objective, and TRANSFORM / REDESIGN its entire frontend style, visual aesthetic, UX feeling, and component architecture strictly using the design system DNA of THEME #248 (Bruno's Experiments - https://bruno-simon.com/).
...
2. TRANSLATE DESIGN DNA (DO NOT COPY PROPRIETARY CONTENT):
   - Do NOT blindly copy placeholder copy, trademarks, or unrelated product catalog from Bruno's Experiments (e.g., do not insert "Bruno's Experiments" branding or unrelated product listings).
   - DO extract and adopt 100% of Bruno's Experiments's visual craft, color palette, typography hierarchy, card structures, spacing rhythm, surface depth, micro-interactions, and UX feeling.

3. ELEVATE & RESKIN EVERY COMPONENT:
   - Reskin the user's existing components (navbars, heroes, product/feature cards, buttons, filters, inputs, modals, footers) into the authentic visual language of THEME #248.
   - Example: If the user's project is an apparel store selling shirts, design a high-craft shirt catalog with Bruno's Experiments's signature layouts, typography scale, lighting, and button styles.

==================================================================
🧬 THEME #248 IDENTITY & EMOTIONAL BRIEF
==================================================================
- Permanent Theme ID: THEME #248
- Reference Design Source: Bruno's Experiments (https://bruno-simon.com/)
- Mode: dark
- Archetype / Category: 3D / WebGL / Immersive
- Design Style: Sculptural Digital Exhibit
- Visual Personality: Bruno's Experiments signature design: sculptural digital exhibit, engineered with high-craft aesthetics, structured hierarchy, and platform-native ergonomics.
- Core Design DNA: Bruno's Experiments design DNA: Full-bleed WebGL 3D canvas, corner HUD interface layout, kinetic typography, magnetic cursor, and spatial physics.

THE SIGNATURE VISUAL ELEMENT (What makes this theme unmistakably Bruno's Experiments):
Deep dark canvas (#080810) with #6366f1 accent used exclusively on primary actions. Product screenshots or interface mockups as the primary visual element. High contrast between surface (#surface) and text creates the premium feel characteristic of Bruno's Experiments.
...
4. RE-ENGINEER every UI component (nav, hero, cards, buttons, inputs, footer) into the Bruno's Experiments visual language while keeping the user's real content, data, and workflows intact.
...
7. VERIFY: The output should feel unmistakably like Bruno's Experiments's design aesthetic applied to the user's own project domain.
