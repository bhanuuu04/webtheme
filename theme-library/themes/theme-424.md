# THEME #424 --- Eight Sleep

- **Website URL:** [https://www.eightsleep.com/](https://www.eightsleep.com/)
...
## 🧬 Theme DNA Summary
> **Eight Sleep design DNA: Matte carbon textures, telemetry spec dials, 360 configurator controls, chamfered components, and industrial precision.**

---

## 🔑 Signature Visual Element
Deep dark canvas (#111215) with #00d2ff accent used exclusively on primary actions. Product screenshots or interface mockups as the primary visual element. High contrast between surface (#surface) and text creates the premium feel characteristic of Eight Sleep.

---

## 🎭 Emotional Intent
Technical precision and professional authority. The user feels Eight Sleep is built by people who understand their craft deeply. The dark aesthetic communicates focus, speed, and zero compromise on quality.

---

## 🎯 Design Principles ("Why does this look like this?")
Why Eight Sleep looks like this: Engineered to communicate sheer performance, mechanical mastery, aerodynamic speed, and premium craft.
...
- Industrial design
- Aerospace
- Eight Sleep-inspired applications
...
## ❌ Things NOT To Copy
  * Proprietary Eight Sleep brand logos
  * Exact Eight Sleep copyrighted assets
...
Your task is to analyze the user's current project / objective, and TRANSFORM / REDESIGN its entire frontend style, visual aesthetic, UX feeling, and component architecture strictly using the design system DNA of THEME #424 (Eight Sleep - https://www.eightsleep.com/).
...
2. TRANSLATE DESIGN DNA (DO NOT COPY PROPRIETARY CONTENT):
   - Do NOT blindly copy placeholder copy, trademarks, or unrelated product catalog from Eight Sleep (e.g., do not insert "Eight Sleep" branding or unrelated product listings).
   - DO extract and adopt 100% of Eight Sleep's visual craft, color palette, typography hierarchy, card structures, spacing rhythm, surface depth, micro-interactions, and UX feeling.

3. ELEVATE & RESKIN EVERY COMPONENT:
   - Reskin the user's existing components (navbars, heroes, product/feature cards, buttons, filters, inputs, modals, footers) into the authentic visual language of THEME #424.
   - Example: If the user's project is an apparel store selling shirts, design a high-craft shirt catalog with Eight Sleep's signature layouts, typography scale, lighting, and button styles.

==================================================================
🧬 THEME #424 IDENTITY & EMOTIONAL BRIEF
==================================================================
- Permanent Theme ID: THEME #424
- Reference Design Source: Eight Sleep (https://www.eightsleep.com/)
- Mode: dark
- Archetype / Category: Automotive / Product
- Design Style: Aerodynamic High-Performance Engineering
- Visual Personality: Eight Sleep signature design: aerodynamic high-performance engineering, engineered with high-craft aesthetics, structured hierarchy, and platform-native ergonomics.
- Core Design DNA: Eight Sleep design DNA: Matte carbon textures, telemetry spec dials, 360 configurator controls, chamfered components, and industrial precision.

THE SIGNATURE VISUAL ELEMENT (What makes this theme unmistakably Eight Sleep):
Deep dark canvas (#111215) with #00d2ff accent used exclusively on primary actions. Product screenshots or interface mockups as the primary visual element. High contrast between surface (#surface) and text creates the premium feel characteristic of Eight Sleep.
...
4. RE-ENGINEER every UI component (nav, hero, cards, buttons, inputs, footer) into the Eight Sleep visual language while keeping the user's real content, data, and workflows intact.
...
7. VERIFY: The output should feel unmistakably like Eight Sleep's design aesthetic applied to the user's own project domain.
