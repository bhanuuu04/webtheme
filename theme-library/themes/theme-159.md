# THEME #159 --- Trigger.dev

- **Website URL:** [https://trigger.dev/](https://trigger.dev/)
...
## 🧬 Theme DNA Summary
> **Trigger.dev design DNA: Terminal windows, syntax highlighting, monospace metadata, hairline borders, and live developer CLI workflows.**

---

## 🔑 Signature Visual Element
Deep dark canvas (#0b0f19) with #22c55e accent used exclusively on primary actions. Product screenshots or interface mockups as the primary visual element. High contrast between surface (#surface) and text creates the premium feel characteristic of Trigger.dev.

---

## 🎭 Emotional Intent
Technical precision and professional authority. The user feels Trigger.dev is built by people who understand their craft deeply. The dark aesthetic communicates focus, speed, and zero compromise on quality.

---

## 🎯 Design Principles ("Why does this look like this?")
Why Trigger.dev looks like this: Built for instant technical comprehension, zero latency, and engineering credibility.
...
- Developer platforms
- CI/CD tools
- Trigger.dev-inspired applications
...
## ❌ Things NOT To Copy
  * Proprietary Trigger.dev brand logos
  * Exact Trigger.dev copyrighted assets
...
Your task is to analyze the user's current project / objective, and TRANSFORM / REDESIGN its entire frontend style, visual aesthetic, UX feeling, and component architecture strictly using the design system DNA of THEME #159 (Trigger.dev - https://trigger.dev/).
...
2. TRANSLATE DESIGN DNA (DO NOT COPY PROPRIETARY CONTENT):
   - Do NOT blindly copy placeholder copy, trademarks, or unrelated product catalog from Trigger.dev (e.g., do not insert "Trigger.dev" branding or unrelated product listings).
   - DO extract and adopt 100% of Trigger.dev's visual craft, color palette, typography hierarchy, card structures, spacing rhythm, surface depth, micro-interactions, and UX feeling.

3. ELEVATE & RESKIN EVERY COMPONENT:
   - Reskin the user's existing components (navbars, heroes, product/feature cards, buttons, filters, inputs, modals, footers) into the authentic visual language of THEME #159.
   - Example: If the user's project is an apparel store selling shirts, design a high-craft shirt catalog with Trigger.dev's signature layouts, typography scale, lighting, and button styles.

==================================================================
🧬 THEME #159 IDENTITY & EMOTIONAL BRIEF
==================================================================
- Permanent Theme ID: THEME #159
- Reference Design Source: Trigger.dev (https://trigger.dev/)
- Mode: dark
- Archetype / Category: Developer / Infrastructure
- Design Style: Monospace Minimalist CLI Hub
- Visual Personality: Trigger.dev signature design: monospace minimalist cli hub, engineered with high-craft aesthetics, structured hierarchy, and platform-native ergonomics.
- Core Design DNA: Trigger.dev design DNA: Terminal windows, syntax highlighting, monospace metadata, hairline borders, and live developer CLI workflows.

THE SIGNATURE VISUAL ELEMENT (What makes this theme unmistakably Trigger.dev):
Deep dark canvas (#0b0f19) with #22c55e accent used exclusively on primary actions. Product screenshots or interface mockups as the primary visual element. High contrast between surface (#surface) and text creates the premium feel characteristic of Trigger.dev.
...
4. RE-ENGINEER every UI component (nav, hero, cards, buttons, inputs, footer) into the Trigger.dev visual language while keeping the user's real content, data, and workflows intact.
...
7. VERIFY: The output should feel unmistakably like Trigger.dev's design aesthetic applied to the user's own project domain.
