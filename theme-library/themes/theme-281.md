...
- **Website URL:** [https://refero.design/](https://refero.design/)
...
## 🧬 Theme DNA Summary
> **Refero design DNA: Kinetic spring physics, interactive dragging elements, playful typography transforms, and scroll-pinned storytelling.**

---

## 🔑 Signature Visual Element
Deep dark canvas (#0f0f11) with #ff5c00 accent used exclusively on primary actions. Product screenshots or interface mockups as the primary visual element. High contrast between surface (#surface) and text creates the premium feel characteristic of Refero.

---

## 🎭 Emotional Intent
Technical precision and professional authority. The user feels Refero is built by people who understand their craft deeply. The dark aesthetic communicates focus, speed, and zero compromise on quality.

---

## 🎯 Design Principles ("Why does this look like this?")
Why Refero looks like this: Engineered to reward user curiosity, delight through micro-interactions, and make software feel alive.
...
## ❌ Things NOT To Copy
  * Proprietary Refero brand logos
  * Exact Refero copyrighted assets
...
Your task is to analyze the user's current project / objective, and TRANSFORM / REDESIGN its entire frontend style, visual aesthetic, UX feeling, and component architecture strictly using the design system DNA of THEME #281 (Refero - https://refero.design/).
...
2. TRANSLATE DESIGN DNA (DO NOT COPY PROPRIETARY CONTENT):
   - Do NOT blindly copy placeholder copy, trademarks, or unrelated product catalog from Refero (e.g., do not insert "Refero" branding or unrelated product listings).
   - DO extract and adopt 100% of Refero's visual craft, color palette, typography hierarchy, card structures, spacing rhythm, surface depth, micro-interactions, and UX feeling.

3. ELEVATE & RESKIN EVERY COMPONENT:
   - Reskin the user's existing components (navbars, heroes, product/feature cards, buttons, filters, inputs, modals, footers) into the authentic visual language of THEME #281.
   - Example: If the user's project is an apparel store selling shirts, design a high-craft shirt catalog with Refero's signature layouts, typography scale, lighting, and button styles.

==================================================================
🧬 THEME #281 IDENTITY & EMOTIONAL BRIEF
==================================================================
- Permanent Theme ID: THEME #281
- Reference Design Source: Refero (https://refero.design/)
- Mode: dark
- Archetype / Category: Motion / Interaction
- Design Style: Scroll-Driven Interactive Story
- Visual Personality: Refero signature design: scroll-driven interactive story, engineered with high-craft aesthetics, structured hierarchy, and platform-native ergonomics.
- Core Design DNA: Refero design DNA: Kinetic spring physics, interactive dragging elements, playful typography transforms, and scroll-pinned storytelling.

THE SIGNATURE VISUAL ELEMENT (What makes this theme unmistakably Refero):
Deep dark canvas (#0f0f11) with #ff5c00 accent used exclusively on primary actions. Product screenshots or interface mockups as the primary visual element. High contrast between surface (#surface) and text creates the premium feel characteristic of Refero.
...
4. RE-ENGINEER every UI component (nav, hero, cards, buttons, inputs, footer) into the Refero visual language while keeping the user's real content, data, and workflows intact.
...
7. VERIFY: The output should feel unmistakably like Refero's design aesthetic applied to the user's own project domain.
