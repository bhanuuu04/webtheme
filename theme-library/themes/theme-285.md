...
- **Website URL:** [https://pttrns.com/](https://pttrns.com/)
...
## 🧬 Theme DNA Summary
> **Pttrns design DNA: Kinetic spring physics, interactive dragging elements, playful typography transforms, and scroll-pinned storytelling.**

---

## 🔑 Signature Visual Element
Deep dark canvas (#0f0f11) with #ff5c00 accent used exclusively on primary actions. Product screenshots or interface mockups as the primary visual element. High contrast between surface (#surface) and text creates the premium feel characteristic of Pttrns.

---

## 🎭 Emotional Intent
Technical precision and professional authority. The user feels Pttrns is built by people who understand their craft deeply. The dark aesthetic communicates focus, speed, and zero compromise on quality.

---

## 🎯 Design Principles ("Why does this look like this?")
Why Pttrns looks like this: Engineered to reward user curiosity, delight through micro-interactions, and make software feel alive.
...
## ❌ Things NOT To Copy
  * Proprietary Pttrns brand logos
  * Exact Pttrns copyrighted assets
...
Your task is to analyze the user's current project / objective, and TRANSFORM / REDESIGN its entire frontend style, visual aesthetic, UX feeling, and component architecture strictly using the design system DNA of THEME #285 (Pttrns - https://pttrns.com/).
...
2. TRANSLATE DESIGN DNA (DO NOT COPY PROPRIETARY CONTENT):
   - Do NOT blindly copy placeholder copy, trademarks, or unrelated product catalog from Pttrns (e.g., do not insert "Pttrns" branding or unrelated product listings).
   - DO extract and adopt 100% of Pttrns's visual craft, color palette, typography hierarchy, card structures, spacing rhythm, surface depth, micro-interactions, and UX feeling.

3. ELEVATE & RESKIN EVERY COMPONENT:
   - Reskin the user's existing components (navbars, heroes, product/feature cards, buttons, filters, inputs, modals, footers) into the authentic visual language of THEME #285.
   - Example: If the user's project is an apparel store selling shirts, design a high-craft shirt catalog with Pttrns's signature layouts, typography scale, lighting, and button styles.

==================================================================
🧬 THEME #285 IDENTITY & EMOTIONAL BRIEF
==================================================================
- Permanent Theme ID: THEME #285
- Reference Design Source: Pttrns (https://pttrns.com/)
- Mode: dark
- Archetype / Category: Motion / Interaction
- Design Style: Playful Tactile Sandbox
- Visual Personality: Pttrns signature design: playful tactile sandbox, engineered with high-craft aesthetics, structured hierarchy, and platform-native ergonomics.
- Core Design DNA: Pttrns design DNA: Kinetic spring physics, interactive dragging elements, playful typography transforms, and scroll-pinned storytelling.

THE SIGNATURE VISUAL ELEMENT (What makes this theme unmistakably Pttrns):
Deep dark canvas (#0f0f11) with #ff5c00 accent used exclusively on primary actions. Product screenshots or interface mockups as the primary visual element. High contrast between surface (#surface) and text creates the premium feel characteristic of Pttrns.
...
4. RE-ENGINEER every UI component (nav, hero, cards, buttons, inputs, footer) into the Pttrns visual language while keeping the user's real content, data, and workflows intact.
...
7. VERIFY: The output should feel unmistakably like Pttrns's design aesthetic applied to the user's own project domain.
