# THEME #230 --- Locomotive Digital Experience

- **Website URL:** [https://locomotive.ca/](https://locomotive.ca/)
...
## 🧬 Theme DNA Summary
> **Locomotive Digital Experience design DNA: Full-bleed WebGL 3D canvas, corner HUD interface layout, kinetic typography, magnetic cursor, and spatial physics.**

---

## 🔑 Signature Visual Element
Deep dark canvas (#080810) with #6366f1 accent used exclusively on primary actions. Product screenshots or interface mockups as the primary visual element. High contrast between surface (#surface) and text creates the premium feel characteristic of Locomotive Digital Experience.

---

## 🎭 Emotional Intent
Technical precision and professional authority. The user feels Locomotive Digital Experience is built by people who understand their craft deeply. The dark aesthetic communicates focus, speed, and zero compromise on quality.

---

## 🎯 Design Principles ("Why does this look like this?")
Why Locomotive Digital Experience looks like this: Engineered to deliver unforgettable tactile immersion, technological awe, and cutting-edge craft.
...
- Luxury concepts
- Locomotive Digital Experience-inspired applications
...
## ❌ Things NOT To Copy
  * Proprietary Locomotive Digital Experience brand logos
  * Exact Locomotive Digital Experience copyrighted assets
...
Your task is to analyze the user's current project / objective, and TRANSFORM / REDESIGN its entire frontend style, visual aesthetic, UX feeling, and component architecture strictly using the design system DNA of THEME #230 (Locomotive Digital Experience - https://locomotive.ca/).
...
2. TRANSLATE DESIGN DNA (DO NOT COPY PROPRIETARY CONTENT):
   - Do NOT blindly copy placeholder copy, trademarks, or unrelated product catalog from Locomotive Digital Experience (e.g., do not insert "Locomotive Digital Experience" branding or unrelated product listings).
   - DO extract and adopt 100% of Locomotive Digital Experience's visual craft, color palette, typography hierarchy, card structures, spacing rhythm, surface depth, micro-interactions, and UX feeling.

3. ELEVATE & RESKIN EVERY COMPONENT:
   - Reskin the user's existing components (navbars, heroes, product/feature cards, buttons, filters, inputs, modals, footers) into the authentic visual language of THEME #230.
   - Example: If the user's project is an apparel store selling shirts, design a high-craft shirt catalog with Locomotive Digital Experience's signature layouts, typography scale, lighting, and button styles.

==================================================================
🧬 THEME #230 IDENTITY & EMOTIONAL BRIEF
==================================================================
- Permanent Theme ID: THEME #230
- Reference Design Source: Locomotive Digital Experience (https://locomotive.ca/)
- Mode: dark
- Archetype / Category: 3D / WebGL / Immersive
- Design Style: Dark Cybernetic 3D Realm
- Visual Personality: Locomotive Digital Experience signature design: dark cybernetic 3d realm, engineered with high-craft aesthetics, structured hierarchy, and platform-native ergonomics.
- Core Design DNA: Locomotive Digital Experience design DNA: Full-bleed WebGL 3D canvas, corner HUD interface layout, kinetic typography, magnetic cursor, and spatial physics.

THE SIGNATURE VISUAL ELEMENT (What makes this theme unmistakably Locomotive Digital Experience):
Deep dark canvas (#080810) with #6366f1 accent used exclusively on primary actions. Product screenshots or interface mockups as the primary visual element. High contrast between surface (#surface) and text creates the premium feel characteristic of Locomotive Digital Experience.
...
4. RE-ENGINEER every UI component (nav, hero, cards, buttons, inputs, footer) into the Locomotive Digital Experience visual language while keeping the user's real content, data, and workflows intact.
...
7. VERIFY: The output should feel unmistakably like Locomotive Digital Experience's design aesthetic applied to the user's own project domain.
