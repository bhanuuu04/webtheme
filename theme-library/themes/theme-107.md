# THEME #107 --- Galileo AI

- **Website URL:** [https://www.usegalileo.ai/](https://www.usegalileo.ai/)
- **Category:** AI
- **Design Style:** Glow-Infused Neural Studio
- **Mode:** dark
- **Tags:** `ai`, `dark`
...
## 🧬 Theme DNA Summary
> **Galileo AI design DNA: Dark void canvas, iridescent neon glow accents, prompt-first conversational UI, and live generative canvas modules.**

---

## 🔑 Signature Visual Element
Deep dark canvas (#0a0a0c) with #06b6d4 accent used exclusively on primary actions. Product screenshots or interface mockups as the primary visual element. High contrast between surface (#surface) and text creates the premium feel characteristic of Galileo AI.

---

## 🎭 Emotional Intent
Technical precision and professional authority. The user feels Galileo AI is built by people who understand their craft deeply. The dark aesthetic communicates focus, speed, and zero compromise on quality.

---

## 🎯 Design Principles ("Why does this look like this?")
Why Galileo AI looks like this: Engineered to evoke machine intelligence, boundless creativity, and real-time generative wonder.
...
- Model playgrounds
- Galileo AI-inspired applications
- AI platforms
...
## ❌ Things NOT To Copy
  * Proprietary Galileo AI brand logos
  * Exact Galileo AI copyrighted assets
...
Your task is to analyze the user's current project / objective, and TRANSFORM / REDESIGN its entire frontend style, visual aesthetic, UX feeling, and component architecture strictly using the design system DNA of THEME #107 (Galileo AI - https://www.usegalileo.ai/).
...
2. TRANSLATE DESIGN DNA (DO NOT COPY PROPRIETARY CONTENT):
   - Do NOT blindly copy placeholder copy, trademarks, or unrelated product catalog from Galileo AI (e.g., do not insert "Galileo AI" branding or unrelated product listings).
   - DO extract and adopt 100% of Galileo AI's visual craft, color palette, typography hierarchy, card structures, spacing rhythm, surface depth, micro-interactions, and UX feeling.

3. ELEVATE & RESKIN EVERY COMPONENT:
   - Reskin the user's existing components (navbars, heroes, product/feature cards, buttons, filters, inputs, modals, footers) into the authentic visual language of THEME #107.
   - Example: If the user's project is an apparel store selling shirts, design a high-craft shirt catalog with Galileo AI's signature layouts, typography scale, lighting, and button styles.

==================================================================
🧬 THEME #107 IDENTITY & EMOTIONAL BRIEF
==================================================================
- Permanent Theme ID: THEME #107
- Reference Design Source: Galileo AI (https://www.usegalileo.ai/)
- Mode: dark
- Archetype / Category: AI
- Design Style: Glow-Infused Neural Studio
- Visual Personality: Galileo AI signature design: glow-infused neural studio, engineered with high-craft aesthetics, structured hierarchy, and platform-native ergonomics.
- Core Design DNA: Galileo AI design DNA: Dark void canvas, iridescent neon glow accents, prompt-first conversational UI, and live generative canvas modules.

THE SIGNATURE VISUAL ELEMENT (What makes this theme unmistakably Galileo AI):
Deep dark canvas (#0a0a0c) with #06b6d4 accent used exclusively on primary actions. Product screenshots or interface mockups as the primary visual element. High contrast between surface (#surface) and text creates the premium feel characteristic of Galileo AI.
...
colors: { bg: '#0a0a0c', surface: '#121216', accent: '#06b6d4', primary: '#f4f4f5', muted: '#a1a1aa' }
...
4. RE-ENGINEER every UI component (nav, hero, cards, buttons, inputs, footer) into the Galileo AI visual language while keeping the user's real content, data, and workflows intact.
...
7. VERIFY: The output should feel unmistakably like Galileo AI's design aesthetic applied to the user's own project domain.
