# THEME #386 --- Mercedes-Benz

- **Website URL:** [https://www.mercedes-benz.com/](https://www.mercedes-benz.com/)
- **Category:** Automotive / Product
- **Design Style:** Industrial Precision Hardware
- **Mode:** dark
- **Tags:** `automotive-product`, `light`

---

## 🧬 Theme DNA Summary
> **Mercedes-Benz design DNA: Matte carbon textures, telemetry spec dials, 360 configurator controls, chamfered components, and industrial precision.**

---

## 🔑 Signature Visual Element
Deep dark canvas (#111215) with #00d2ff accent used exclusively on primary actions. Product screenshots or interface mockups as the primary visual element. High contrast between surface (#surface) and text creates the premium feel characteristic of Mercedes-Benz.

---

## 🎭 Emotional Intent
Technical precision and professional authority. The user feels Mercedes-Benz is built by people who understand their craft deeply. The dark aesthetic communicates focus, speed, and zero compromise on quality.

---

## 🎯 Design Principles ("Why does this look like this?")
Why Mercedes-Benz looks like this: Engineered to communicate sheer performance, mechanical mastery, aerodynamic speed, and premium craft.
...
### Primary Palette
- **`#111215`** --- Titanium Grey Canvas
- **`#00d2ff`** --- Electric Cyan Indicator
- **`#f1f5f9`** --- Primary Title
...
- Industrial design
- Aerospace
- Mercedes-Benz-inspired applications
...
## ❌ Things NOT To Copy
  * Proprietary Mercedes-Benz brand logos
  * Exact Mercedes-Benz copyrighted assets
...
Your task is to analyze the user's current project / objective, and TRANSFORM / REDESIGN its entire frontend style, visual aesthetic, UX feeling, and component architecture strictly using the design system DNA of THEME #386 (Mercedes-Benz - https://www.mercedes-benz.com/).
...
2. TRANSLATE DESIGN DNA (DO NOT COPY PROPRIETARY CONTENT):
   - Do NOT blindly copy placeholder copy, trademarks, or unrelated product catalog from Mercedes-Benz (e.g., do not insert "Mercedes-Benz" branding or unrelated product listings).
   - DO extract and adopt 100% of Mercedes-Benz's visual craft, color palette, typography hierarchy, card structures, spacing rhythm, surface depth, micro-interactions, and UX feeling.

3. ELEVATE & RESKIN EVERY COMPONENT:
   - Reskin the user's existing components (navbars, heroes, product/feature cards, buttons, filters, inputs, modals, footers) into the authentic visual language of THEME #386.
   - Example: If the user's project is an apparel store selling shirts, design a high-craft shirt catalog with Mercedes-Benz's signature layouts, typography scale, lighting, and button styles.

==================================================================
🧬 THEME #386 IDENTITY & EMOTIONAL BRIEF
==================================================================
- Permanent Theme ID: THEME #386
- Reference Design Source: Mercedes-Benz (https://www.mercedes-benz.com/)
- Mode: dark
- Archetype / Category: Automotive / Product
- Design Style: Industrial Precision Hardware
- Visual Personality: Mercedes-Benz signature design: industrial precision hardware, engineered with high-craft aesthetics, structured hierarchy, and platform-native ergonomics.
- Core Design DNA: Mercedes-Benz design DNA: Matte carbon textures, telemetry spec dials, 360 configurator controls, chamfered components, and industrial precision.

THE SIGNATURE VISUAL ELEMENT (What makes this theme unmistakably Mercedes-Benz):
Deep dark canvas (#111215) with #00d2ff accent used exclusively on primary actions. Product screenshots or interface mockups as the primary visual element. High contrast between surface (#surface) and text creates the premium feel characteristic of Mercedes-Benz.
...
==================================================================
#111215  ->  page background, all section backgrounds
#00d2ff  ->  primary CTA buttons, links on hover, focus rings, selected states, brand accents
#f1f5f9  ->  all headings (H1-H3), body text, primary UI labels
...
colors: { bg: '#111215', surface: '#1c1d22', accent: '#00d2ff', primary: '#f1f5f9', muted: '#8a8d9b' }
...
4. RE-ENGINEER every UI component (nav, hero, cards, buttons, inputs, footer) into the Mercedes-Benz visual language while keeping the user's real content, data, and workflows intact.
...
7. VERIFY: The output should feel unmistakably like Mercedes-Benz's design aesthetic applied to the user's own project domain.
