# THEME #122 --- Google Cloud

- **Website URL:** [https://cloud.google.com/](https://cloud.google.com/)
...
## 🧬 Theme DNA Summary
> **Google Cloud design DNA: Terminal windows, syntax highlighting, monospace metadata, hairline borders, and live developer CLI workflows.**

---

## 🔑 Signature Visual Element
Deep dark canvas (#030712) with #38bdf8 accent used exclusively on primary actions. Product screenshots or interface mockups as the primary visual element. High contrast between surface (#surface) and text creates the premium feel characteristic of Google Cloud.

---

## 🎭 Emotional Intent
Technical precision and professional authority. The user feels Google Cloud is built by people who understand their craft deeply. The dark aesthetic communicates focus, speed, and zero compromise on quality.

---

## 🎯 Design Principles ("Why does this look like this?")
Why Google Cloud looks like this: Built for instant technical comprehension, zero latency, and engineering credibility.
...
- Developer platforms
- CI/CD tools
- Google Cloud-inspired applications
...
## ❌ Things NOT To Copy
  * Proprietary Google Cloud brand logos
  * Exact Google Cloud copyrighted assets
...
Your task is to analyze the user's current project / objective, and TRANSFORM / REDESIGN its entire frontend style, visual aesthetic, UX feeling, and component architecture strictly using the design system DNA of THEME #122 (Google Cloud - https://cloud.google.com/).
...
2. TRANSLATE DESIGN DNA (DO NOT COPY PROPRIETARY CONTENT):
   - Do NOT blindly copy placeholder copy, trademarks, or unrelated product catalog from Google Cloud (e.g., do not insert "Google Cloud" branding or unrelated product listings).
   - DO extract and adopt 100% of Google Cloud's visual craft, color palette, typography hierarchy, card structures, spacing rhythm, surface depth, micro-interactions, and UX feeling.

3. ELEVATE & RESKIN EVERY COMPONENT:
   - Reskin the user's existing components (navbars, heroes, product/feature cards, buttons, filters, inputs, modals, footers) into the authentic visual language of THEME #122.
   - Example: If the user's project is an apparel store selling shirts, design a high-craft shirt catalog with Google Cloud's signature layouts, typography scale, lighting, and button styles.

==================================================================
🧬 THEME #122 IDENTITY & EMOTIONAL BRIEF
==================================================================
- Permanent Theme ID: THEME #122
- Reference Design Source: Google Cloud (https://cloud.google.com/)
- Mode: dark
- Archetype / Category: Developer / Infrastructure
- Design Style: Isometric Architectural Infrastructure
- Visual Personality: Google Cloud signature design: isometric architectural infrastructure, engineered with high-craft aesthetics, structured hierarchy, and platform-native ergonomics.
- Core Design DNA: Google Cloud design DNA: Terminal windows, syntax highlighting, monospace metadata, hairline borders, and live developer CLI workflows.

THE SIGNATURE VISUAL ELEMENT (What makes this theme unmistakably Google Cloud):
Deep dark canvas (#030712) with #38bdf8 accent used exclusively on primary actions. Product screenshots or interface mockups as the primary visual element. High contrast between surface (#surface) and text creates the premium feel characteristic of Google Cloud.
...
4. RE-ENGINEER every UI component (nav, hero, cards, buttons, inputs, footer) into the Google Cloud visual language while keeping the user's real content, data, and workflows intact.
...
7. VERIFY: The output should feel unmistakably like Google Cloud's design aesthetic applied to the user's own project domain.
