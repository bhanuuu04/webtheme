...
- **Website URL:** [https://www.krea.ai/](https://www.krea.ai/)
- **Category:** AI
...
## 🧬 Theme DNA Summary
> **Krea design DNA: Dark void canvas, iridescent neon glow accents, prompt-first conversational UI, and live generative canvas modules.**

---

## 🔑 Signature Visual Element
Deep dark canvas (#050505) with #a855f7 accent used exclusively on primary actions. Product screenshots or interface mockups as the primary visual element. High contrast between surface (#surface) and text creates the premium feel characteristic of Krea.

---

## 🎭 Emotional Intent
Technical precision and professional authority. The user feels Krea is built by people who understand their craft deeply. The dark aesthetic communicates focus, speed, and zero compromise on quality.

---

## 🎯 Design Principles ("Why does this look like this?")
Why Krea looks like this: Engineered to evoke machine intelligence, boundless creativity, and real-time generative wonder.
...
## ❌ Things NOT To Copy
  * Proprietary Krea brand logos
  * Exact Krea copyrighted assets
...
Your task is to analyze the user's current project / objective, and TRANSFORM / REDESIGN its entire frontend style, visual aesthetic, UX feeling, and component architecture strictly using the design system DNA of THEME #079 (Krea - https://www.krea.ai/).
...
2. TRANSLATE DESIGN DNA (DO NOT COPY PROPRIETARY CONTENT):
   - Do NOT blindly copy placeholder copy, trademarks, or unrelated product catalog from Krea (e.g., do not insert "Krea" branding or unrelated product listings).
   - DO extract and adopt 100% of Krea's visual craft, color palette, typography hierarchy, card structures, spacing rhythm, surface depth, micro-interactions, and UX feeling.

3. ELEVATE & RESKIN EVERY COMPONENT:
   - Reskin the user's existing components (navbars, heroes, product/feature cards, buttons, filters, inputs, modals, footers) into the authentic visual language of THEME #079.
   - Example: If the user's project is an apparel store selling shirts, design a high-craft shirt catalog with Krea's signature layouts, typography scale, lighting, and button styles.

==================================================================
🧬 THEME #079 IDENTITY & EMOTIONAL BRIEF
==================================================================
- Permanent Theme ID: THEME #079
- Reference Design Source: Krea (https://www.krea.ai/)
- Mode: dark
- Archetype / Category: AI
- Design Style: Glow-Infused Neural Studio
- Visual Personality: Krea signature design: glow-infused neural studio, engineered with high-craft aesthetics, structured hierarchy, and platform-native ergonomics.
- Core Design DNA: Krea design DNA: Dark void canvas, iridescent neon glow accents, prompt-first conversational UI, and live generative canvas modules.

THE SIGNATURE VISUAL ELEMENT (What makes this theme unmistakably Krea):
Deep dark canvas (#050505) with #a855f7 accent used exclusively on primary actions. Product screenshots or interface mockups as the primary visual element. High contrast between surface (#surface) and text creates the premium feel characteristic of Krea.
...
4. RE-ENGINEER every UI component (nav, hero, cards, buttons, inputs, footer) into the Krea visual language while keeping the user's real content, data, and workflows intact.
...
7. VERIFY: The output should feel unmistakably like Krea's design aesthetic applied to the user's own project domain.
