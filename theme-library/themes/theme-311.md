# THEME #311 --- Studio Freight

- **Website URL:** [https://www.studiofreight.com/](https://www.studiofreight.com/)
...
## 🧬 Theme DNA Summary
> **Studio Freight design DNA: Giant editorial display typography, raw 0px brutalist grids, project index table view, and floating media cursor previews.**

---

## 🔑 Signature Visual Element
Deep dark canvas (#000000) with #ffffff accent used exclusively on primary actions. Product screenshots or interface mockups as the primary visual element. High contrast between surface (#surface) and text creates the premium feel characteristic of Studio Freight.

---

## 🎭 Emotional Intent
Technical precision and professional authority. The user feels Studio Freight is built by people who understand their craft deeply. The dark aesthetic communicates focus, speed, and zero compromise on quality.

---

## 🎯 Design Principles ("Why does this look like this?")
Why Studio Freight looks like this: Engineered to establish creative authority, cultural relevance, and fearless artistic vision.
...
- Studio Freight-inspired applications
...
## ❌ Things NOT To Copy
  * Proprietary Studio Freight brand logos
  * Exact Studio Freight copyrighted assets
...
Your task is to analyze the user's current project / objective, and TRANSFORM / REDESIGN its entire frontend style, visual aesthetic, UX feeling, and component architecture strictly using the design system DNA of THEME #311 (Studio Freight - https://www.studiofreight.com/).
...
2. TRANSLATE DESIGN DNA (DO NOT COPY PROPRIETARY CONTENT):
   - Do NOT blindly copy placeholder copy, trademarks, or unrelated product catalog from Studio Freight (e.g., do not insert "Studio Freight" branding or unrelated product listings).
   - DO extract and adopt 100% of Studio Freight's visual craft, color palette, typography hierarchy, card structures, spacing rhythm, surface depth, micro-interactions, and UX feeling.

3. ELEVATE & RESKIN EVERY COMPONENT:
   - Reskin the user's existing components (navbars, heroes, product/feature cards, buttons, filters, inputs, modals, footers) into the authentic visual language of THEME #311.
   - Example: If the user's project is an apparel store selling shirts, design a high-craft shirt catalog with Studio Freight's signature layouts, typography scale, lighting, and button styles.

==================================================================
🧬 THEME #311 IDENTITY & EMOTIONAL BRIEF
==================================================================
- Permanent Theme ID: THEME #311
- Reference Design Source: Studio Freight (https://www.studiofreight.com/)
- Mode: dark
- Archetype / Category: Creative Agencies / Studios
- Design Style: High-Contrast Minimalist Agency
- Visual Personality: Studio Freight signature design: high-contrast minimalist agency, engineered with high-craft aesthetics, structured hierarchy, and platform-native ergonomics.
- Core Design DNA: Studio Freight design DNA: Giant editorial display typography, raw 0px brutalist grids, project index table view, and floating media cursor previews.

THE SIGNATURE VISUAL ELEMENT (What makes this theme unmistakably Studio Freight):
Deep dark canvas (#000000) with #ffffff accent used exclusively on primary actions. Product screenshots or interface mockups as the primary visual element. High contrast between surface (#surface) and text creates the premium feel characteristic of Studio Freight.
...
4. RE-ENGINEER every UI component (nav, hero, cards, buttons, inputs, footer) into the Studio Freight visual language while keeping the user's real content, data, and workflows intact.
...
7. VERIFY: The output should feel unmistakably like Studio Freight's design aesthetic applied to the user's own project domain.
