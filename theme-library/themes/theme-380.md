# THEME #380 --- Maison Kitsune

- **Website URL:** [https://maisonkitsune.com/](https://maisonkitsune.com/)
- **Category:** Luxury / Fashion
- **Design Style:** Warm Sunlit Atelier
- **Mode:** light
...
## 🧬 Theme DNA Summary
> **Maison Kitsune design DNA: Exquisite serif typography, expansive ivory/obsidian whitespace, 3:4 lookbook imagery, and slow graceful transitions.**

---

## 🔑 Signature Visual Element
Clean white editorial canvas with #1a1818 as the single brand accent color. Large display typography and generous whitespace communicate the premium quality of Maison Kitsune. Product screenshots or lifestyle imagery on clean white/off-white backgrounds.

---

## 🎭 Emotional Intent
Clarity and trustworthiness. The user feels confident that Maison Kitsune is the right choice — professional, accessible, and purpose-built for their needs. The clean light design removes friction and communicates reliability.

---

## 🎯 Design Principles ("Why does this look like this?")
Why Maison Kitsune looks like this: Engineered to evoke timeless elegance, craftsmanship, exclusivity, and quiet luxury.
...
- Hospitality & resorts
- Fragrance & beauty
- Maison Kitsune-inspired applications
...
## ❌ Things NOT To Copy
  * Proprietary Maison Kitsune brand logos
  * Exact Maison Kitsune copyrighted assets
...
Your task is to analyze the user's current project / objective, and TRANSFORM / REDESIGN its entire frontend style, visual aesthetic, UX feeling, and component architecture strictly using the design system DNA of THEME #380 (Maison Kitsune - https://maisonkitsune.com/).
...
2. TRANSLATE DESIGN DNA (DO NOT COPY PROPRIETARY CONTENT):
   - Do NOT blindly copy placeholder copy, trademarks, or unrelated product catalog from Maison Kitsune (e.g., do not insert "Maison Kitsune" branding or unrelated product listings).
   - DO extract and adopt 100% of Maison Kitsune's visual craft, color palette, typography hierarchy, card structures, spacing rhythm, surface depth, micro-interactions, and UX feeling.

3. ELEVATE & RESKIN EVERY COMPONENT:
   - Reskin the user's existing components (navbars, heroes, product/feature cards, buttons, filters, inputs, modals, footers) into the authentic visual language of THEME #380.
   - Example: If the user's project is an apparel store selling shirts, design a high-craft shirt catalog with Maison Kitsune's signature layouts, typography scale, lighting, and button styles.

==================================================================
🧬 THEME #380 IDENTITY & EMOTIONAL BRIEF
==================================================================
- Permanent Theme ID: THEME #380
- Reference Design Source: Maison Kitsune (https://maisonkitsune.com/)
- Mode: light
- Archetype / Category: Luxury / Fashion
- Design Style: Warm Sunlit Atelier
- Visual Personality: Maison Kitsune signature design: warm sunlit atelier, engineered with high-craft aesthetics, structured hierarchy, and platform-native ergonomics.
- Core Design DNA: Maison Kitsune design DNA: Exquisite serif typography, expansive ivory/obsidian whitespace, 3:4 lookbook imagery, and slow graceful transitions.

THE SIGNATURE VISUAL ELEMENT (What makes this theme unmistakably Maison Kitsune):
Clean white editorial canvas with #1a1818 as the single brand accent color. Large display typography and generous whitespace communicate the premium quality of Maison Kitsune. Product screenshots or lifestyle imagery on clean white/off-white backgrounds.
...
4. RE-ENGINEER every UI component (nav, hero, cards, buttons, inputs, footer) into the Maison Kitsune visual language while keeping the user's real content, data, and workflows intact.
...
7. VERIFY: The output should feel unmistakably like Maison Kitsune's design aesthetic applied to the user's own project domain.
