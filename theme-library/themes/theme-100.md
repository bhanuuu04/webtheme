# THEME #100 --- Wispr Flow

- **Website URL:** [https://wisprflow.ai/](https://wisprflow.ai/)
- **Category:** AI
- **Design Style:** Editorial AI Research Hub
- **Mode:** dark
- **Tags:** `ai`, `dark`, `editorial`

---

## 🧬 Theme DNA Summary
> **Wispr Flow design DNA: Dark void canvas, iridescent neon glow accents, prompt-first conversational UI, and live generative canvas modules.**

---

## 🔑 Signature Visual Element
Deep dark canvas (#050505) with #a855f7 accent used exclusively on primary actions. Product screenshots or interface mockups as the primary visual element. High contrast between surface (#surface) and text creates the premium feel characteristic of Wispr Flow.

---

## 🎭 Emotional Intent
Technical precision and professional authority. The user feels Wispr Flow is built by people who understand their craft deeply. The dark aesthetic communicates focus, speed, and zero compromise on quality.

---

## 🎯 Design Principles ("Why does this look like this?")
Why Wispr Flow looks like this: Engineered to evoke machine intelligence, boundless creativity, and real-time generative wonder.
...
- Model playgrounds
- Wispr Flow-inspired applications
- AI platforms
...
## ❌ Things NOT To Copy
  * Proprietary Wispr Flow brand logos
  * Exact Wispr Flow copyrighted assets
...
Your task is to analyze the user's current project / objective, and TRANSFORM / REDESIGN its entire frontend style, visual aesthetic, UX feeling, and component architecture strictly using the design system DNA of THEME #100 (Wispr Flow - https://wisprflow.ai/).
...
2. TRANSLATE DESIGN DNA (DO NOT COPY PROPRIETARY CONTENT):
   - Do NOT blindly copy placeholder copy, trademarks, or unrelated product catalog from Wispr Flow (e.g., do not insert "Wispr Flow" branding or unrelated product listings).
   - DO extract and adopt 100% of Wispr Flow's visual craft, color palette, typography hierarchy, card structures, spacing rhythm, surface depth, micro-interactions, and UX feeling.

3. ELEVATE & RESKIN EVERY COMPONENT:
   - Reskin the user's existing components (navbars, heroes, product/feature cards, buttons, filters, inputs, modals, footers) into the authentic visual language of THEME #100.
   - Example: If the user's project is an apparel store selling shirts, design a high-craft shirt catalog with Wispr Flow's signature layouts, typography scale, lighting, and button styles.

==================================================================
🧬 THEME #100 IDENTITY & EMOTIONAL BRIEF
==================================================================
- Permanent Theme ID: THEME #100
- Reference Design Source: Wispr Flow (https://wisprflow.ai/)
- Mode: dark
- Archetype / Category: AI
- Design Style: Editorial AI Research Hub
- Visual Personality: Wispr Flow signature design: editorial ai research hub, engineered with high-craft aesthetics, structured hierarchy, and platform-native ergonomics.
- Core Design DNA: Wispr Flow design DNA: Dark void canvas, iridescent neon glow accents, prompt-first conversational UI, and live generative canvas modules.

THE SIGNATURE VISUAL ELEMENT (What makes this theme unmistakably Wispr Flow):
Deep dark canvas (#050505) with #a855f7 accent used exclusively on primary actions. Product screenshots or interface mockups as the primary visual element. High contrast between surface (#surface) and text creates the premium feel characteristic of Wispr Flow.
...
4. RE-ENGINEER every UI component (nav, hero, cards, buttons, inputs, footer) into the Wispr Flow visual language while keeping the user's real content, data, and workflows intact.
...
7. VERIFY: The output should feel unmistakably like Wispr Flow's design aesthetic applied to the user's own project domain.
