...
- **Website URL:** [https://www.uniqlo.com/](https://www.uniqlo.com/)
...
## 🧬 Theme DNA Summary
> **Uniqlo design DNA: Exquisite serif typography, expansive ivory/obsidian whitespace, 3:4 lookbook imagery, and slow graceful transitions.**

---

## 🔑 Signature Visual Element
Deep dark canvas (#0c0c0c) with #d4af37 accent used exclusively on primary actions. Product screenshots or interface mockups as the primary visual element. High contrast between surface (#surface) and text creates the premium feel characteristic of Uniqlo.

---

## 🎭 Emotional Intent
Technical precision and professional authority. The user feels Uniqlo is built by people who understand their craft deeply. The dark aesthetic communicates focus, speed, and zero compromise on quality.

---

## 🎯 Design Principles ("Why does this look like this?")
Why Uniqlo looks like this: Engineered to evoke timeless elegance, craftsmanship, exclusivity, and quiet luxury.
...
## ❌ Things NOT To Copy
  * Proprietary Uniqlo brand logos
  * Exact Uniqlo copyrighted assets
...
Your task is to analyze the user's current project / objective, and TRANSFORM / REDESIGN its entire frontend style, visual aesthetic, UX feeling, and component architecture strictly using the design system DNA of THEME #383 (Uniqlo - https://www.uniqlo.com/).
...
2. TRANSLATE DESIGN DNA (DO NOT COPY PROPRIETARY CONTENT):
   - Do NOT blindly copy placeholder copy, trademarks, or unrelated product catalog from Uniqlo (e.g., do not insert "Uniqlo" branding or unrelated product listings).
   - DO extract and adopt 100% of Uniqlo's visual craft, color palette, typography hierarchy, card structures, spacing rhythm, surface depth, micro-interactions, and UX feeling.

3. ELEVATE & RESKIN EVERY COMPONENT:
   - Reskin the user's existing components (navbars, heroes, product/feature cards, buttons, filters, inputs, modals, footers) into the authentic visual language of THEME #383.
   - Example: If the user's project is an apparel store selling shirts, design a high-craft shirt catalog with Uniqlo's signature layouts, typography scale, lighting, and button styles.

==================================================================
🧬 THEME #383 IDENTITY & EMOTIONAL BRIEF
==================================================================
- Permanent Theme ID: THEME #383
- Reference Design Source: Uniqlo (https://www.uniqlo.com/)
- Mode: dark
- Archetype / Category: Luxury / Fashion
- Design Style: Dark Opulent Luxury Maison
- Visual Personality: Uniqlo signature design: dark opulent luxury maison, engineered with high-craft aesthetics, structured hierarchy, and platform-native ergonomics.
- Core Design DNA: Uniqlo design DNA: Exquisite serif typography, expansive ivory/obsidian whitespace, 3:4 lookbook imagery, and slow graceful transitions.

THE SIGNATURE VISUAL ELEMENT (What makes this theme unmistakably Uniqlo):
Deep dark canvas (#0c0c0c) with #d4af37 accent used exclusively on primary actions. Product screenshots or interface mockups as the primary visual element. High contrast between surface (#surface) and text creates the premium feel characteristic of Uniqlo.
...
4. RE-ENGINEER every UI component (nav, hero, cards, buttons, inputs, footer) into the Uniqlo visual language while keeping the user's real content, data, and workflows intact.
...
7. VERIFY: The output should feel unmistakably like Uniqlo's design aesthetic applied to the user's own project domain.
