# THEME #470 --- Blue Bottle Coffee

- **Website URL:** [https://bluebottlecoffee.com/](https://bluebottlecoffee.com/)
...
## 🧬 Theme DNA Summary
> **Blue Bottle Coffee design DNA: Product shelf grids, secondary hover image flips, instant slide-over cart drawer, and high-contrast Add to Cart CTA.**

---

## 🔑 Signature Visual Element
Clean white editorial canvas with #27272a as the single brand accent color. Large display typography and generous whitespace communicate the premium quality of Blue Bottle Coffee. Product screenshots or lifestyle imagery on clean white/off-white backgrounds.

---

## 🎭 Emotional Intent
Clarity and trustworthiness. The user feels confident that Blue Bottle Coffee is the right choice — professional, accessible, and purpose-built for their needs. The clean light design removes friction and communicates reliability.

---

## 🎯 Design Principles ("Why does this look like this?")
Why Blue Bottle Coffee looks like this: Engineered to maximize product desirability, minimize checkout friction, and convey brand lifestyle authenticity.
...
### Primary Palette
- **`#fefdfa`** --- Warm Cotton Canvas
- **`#27272a`** --- Deep Neutral Text
- **`#059669`** --- Botanical Green Accent
...
- Subscription boxes
- Blue Bottle Coffee-inspired applications
...
## ❌ Things NOT To Copy
  * Proprietary Blue Bottle Coffee brand logos
  * Exact Blue Bottle Coffee copyrighted assets
...
Your task is to analyze the user's current project / objective, and TRANSFORM / REDESIGN its entire frontend style, visual aesthetic, UX feeling, and component architecture strictly using the design system DNA of THEME #470 (Blue Bottle Coffee - https://bluebottlecoffee.com/).
...
2. TRANSLATE DESIGN DNA (DO NOT COPY PROPRIETARY CONTENT):
   - Do NOT blindly copy placeholder copy, trademarks, or unrelated product catalog from Blue Bottle Coffee (e.g., do not insert "Blue Bottle Coffee" branding or unrelated product listings).
   - DO extract and adopt 100% of Blue Bottle Coffee's visual craft, color palette, typography hierarchy, card structures, spacing rhythm, surface depth, micro-interactions, and UX feeling.

3. ELEVATE & RESKIN EVERY COMPONENT:
   - Reskin the user's existing components (navbars, heroes, product/feature cards, buttons, filters, inputs, modals, footers) into the authentic visual language of THEME #470.
   - Example: If the user's project is an apparel store selling shirts, design a high-craft shirt catalog with Blue Bottle Coffee's signature layouts, typography scale, lighting, and button styles.

==================================================================
🧬 THEME #470 IDENTITY & EMOTIONAL BRIEF
==================================================================
- Permanent Theme ID: THEME #470
- Reference Design Source: Blue Bottle Coffee (https://bluebottlecoffee.com/)
- Mode: light
- Archetype / Category: E-commerce / Consumer
- Design Style: Minimalist Clean Curation
- Visual Personality: Blue Bottle Coffee signature design: minimalist clean curation, engineered with high-craft aesthetics, structured hierarchy, and platform-native ergonomics.
- Core Design DNA: Blue Bottle Coffee design DNA: Product shelf grids, secondary hover image flips, instant slide-over cart drawer, and high-contrast Add to Cart CTA.

THE SIGNATURE VISUAL ELEMENT (What makes this theme unmistakably Blue Bottle Coffee):
Clean white editorial canvas with #27272a as the single brand accent color. Large display typography and generous whitespace communicate the premium quality of Blue Bottle Coffee. Product screenshots or lifestyle imagery on clean white/off-white backgrounds.
...
==================================================================
#fefdfa  ->  page background, all section backgrounds
#27272a  ->  primary CTA buttons, links on hover, focus rings, selected states, brand accents
#059669  ->  all headings (H1-H3), body text, primary UI labels
...
colors: { bg: '#fefdfa', surface: '#f4f4f5', accent: '#27272a', primary: '#059669', muted: '#71717a' }
...
4. RE-ENGINEER every UI component (nav, hero, cards, buttons, inputs, footer) into the Blue Bottle Coffee visual language while keeping the user's real content, data, and workflows intact.
...
7. VERIFY: The output should feel unmistakably like Blue Bottle Coffee's design aesthetic applied to the user's own project domain.
