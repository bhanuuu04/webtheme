...
- **Website URL:** [https://www.wearecollins.com/](https://www.wearecollins.com/)
...
## 🧬 Theme DNA Summary
> **Collins design DNA: Giant editorial display typography, raw 0px brutalist grids, project index table view, and floating media cursor previews.**

---

## 🔑 Signature Visual Element
Deep dark canvas (#000000) with #ffffff accent used exclusively on primary actions. Product screenshots or interface mockups as the primary visual element. High contrast between surface (#surface) and text creates the premium feel characteristic of Collins.

---

## 🎭 Emotional Intent
Technical precision and professional authority. The user feels Collins is built by people who understand their craft deeply. The dark aesthetic communicates focus, speed, and zero compromise on quality.

---

## 🎯 Design Principles ("Why does this look like this?")
Why Collins looks like this: Engineered to establish creative authority, cultural relevance, and fearless artistic vision.
...
## ❌ Things NOT To Copy
  * Proprietary Collins brand logos
  * Exact Collins copyrighted assets
...
Your task is to analyze the user's current project / objective, and TRANSFORM / REDESIGN its entire frontend style, visual aesthetic, UX feeling, and component architecture strictly using the design system DNA of THEME #331 (Collins - https://www.wearecollins.com/).
...
2. TRANSLATE DESIGN DNA (DO NOT COPY PROPRIETARY CONTENT):
   - Do NOT blindly copy placeholder copy, trademarks, or unrelated product catalog from Collins (e.g., do not insert "Collins" branding or unrelated product listings).
   - DO extract and adopt 100% of Collins's visual craft, color palette, typography hierarchy, card structures, spacing rhythm, surface depth, micro-interactions, and UX feeling.

3. ELEVATE & RESKIN EVERY COMPONENT:
   - Reskin the user's existing components (navbars, heroes, product/feature cards, buttons, filters, inputs, modals, footers) into the authentic visual language of THEME #331.
   - Example: If the user's project is an apparel store selling shirts, design a high-craft shirt catalog with Collins's signature layouts, typography scale, lighting, and button styles.

==================================================================
🧬 THEME #331 IDENTITY & EMOTIONAL BRIEF
==================================================================
- Permanent Theme ID: THEME #331
- Reference Design Source: Collins (https://www.wearecollins.com/)
- Mode: dark
- Archetype / Category: Creative Agencies / Studios
- Design Style: High-Contrast Minimalist Agency
- Visual Personality: Collins signature design: high-contrast minimalist agency, engineered with high-craft aesthetics, structured hierarchy, and platform-native ergonomics.
- Core Design DNA: Collins design DNA: Giant editorial display typography, raw 0px brutalist grids, project index table view, and floating media cursor previews.

THE SIGNATURE VISUAL ELEMENT (What makes this theme unmistakably Collins):
Deep dark canvas (#000000) with #ffffff accent used exclusively on primary actions. Product screenshots or interface mockups as the primary visual element. High contrast between surface (#surface) and text creates the premium feel characteristic of Collins.
...
4. RE-ENGINEER every UI component (nav, hero, cards, buttons, inputs, footer) into the Collins visual language while keeping the user's real content, data, and workflows intact.
...
7. VERIFY: The output should feel unmistakably like Collins's design aesthetic applied to the user's own project domain.
