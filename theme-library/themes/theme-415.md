# THEME #415 --- Teenage Engineering

- **Website URL:** [https://teenage.engineering/](https://teenage.engineering/)
- **Category:** Automotive / Product
- **Design Style:** Aerodynamic High-Performance Engineering
- **Mode:** dark
- **Tags:** `automotive-product`, `dark`

---

## 🧬 Theme DNA Summary
> **Teenage Engineering design DNA: Matte carbon textures, telemetry spec dials, 360 configurator controls, chamfered components, and industrial precision.**

---

## 🔑 Signature Visual Element
Deep dark canvas (#0a0a0c) with #e11d48 accent used exclusively on primary actions. Product screenshots or interface mockups as the primary visual element. High contrast between surface (#surface) and text creates the premium feel characteristic of Teenage Engineering.

---

## 🎭 Emotional Intent
Technical precision and professional authority. The user feels Teenage Engineering is built by people who understand their craft deeply. The dark aesthetic communicates focus, speed, and zero compromise on quality.

---

## 🎯 Design Principles ("Why does this look like this?")
Why Teenage Engineering looks like this: Engineered to communicate sheer performance, mechanical mastery, aerodynamic speed, and premium craft.
...
### Primary Palette
- **`#0a0a0c`** --- Matte Carbon Canvas
- **`#e11d48`** --- Brembo Red Accent
- **`#ffffff`** --- Instrument Cluster Text

### Secondary & Surface Palette
- **`#1c1d22`** --- Hardware Surface
- **`#30323a`** --- Bezel Hairline
- **`#8a8d9b`** --- Telemetry Data Text
...
- Consumer hardware & robotics
- Electric vehicles
- Industrial design
- Aerospace
- Teenage Engineering-inspired applications
- Automotive / Product platforms

---

## ✅ Things To Reuse
  * Performance spec metrics grid
  * 360 configurator UI pattern
  * Telemetry speed gauge
  * Chamfered button styling

---

## ❌ Things NOT To Copy
  * Proprietary Teenage Engineering brand logos
  * Exact Teenage Engineering copyrighted assets
  * Direct company trademarks

---

## 🛠️ Implementation Notes
Development Guide: Use bg-zinc-950, high-contrast technical data metrics, red or cyan accents, and bold condensed typography.
...
Your task is to analyze the user's current project / objective, and TRANSFORM / REDESIGN its entire frontend style, visual aesthetic, UX feeling, and component architecture strictly using the design system DNA of THEME #415 (Teenage Engineering - https://teenage.engineering/).
...
2. TRANSLATE DESIGN DNA (DO NOT COPY PROPRIETARY CONTENT):
   - Do NOT blindly copy placeholder copy, trademarks, or unrelated product catalog from Teenage Engineering (e.g., do not insert "Teenage Engineering" branding or unrelated product listings).
   - DO extract and adopt 100% of Teenage Engineering's visual craft, color palette, typography hierarchy, card structures, spacing rhythm, surface depth, micro-interactions, and UX feeling.

3. ELEVATE & RESKIN EVERY COMPONENT:
   - Reskin the user's existing components (navbars, heroes, product/feature cards, buttons, filters, inputs, modals, footers) into the authentic visual language of THEME #415.
   - Example: If the user's project is an apparel store selling shirts, design a high-craft shirt catalog with Teenage Engineering's signature layouts, typography scale, lighting, and button styles.

==================================================================
🧬 THEME #415 IDENTITY & EMOTIONAL BRIEF
==================================================================
- Permanent Theme ID: THEME #415
- Reference Design Source: Teenage Engineering (https://teenage.engineering/)
- Mode: dark
- Archetype / Category: Automotive / Product
- Design Style: Aerodynamic High-Performance Engineering
- Visual Personality: Teenage Engineering signature design: aerodynamic high-performance engineering, engineered with high-craft aesthetics, structured hierarchy, and platform-native ergonomics.
- Core Design DNA: Teenage Engineering design DNA: Matte carbon textures, telemetry spec dials, 360 configurator controls, chamfered components, and industrial precision.

THE SIGNATURE VISUAL ELEMENT (What makes this theme unmistakably Teenage Engineering):
Deep dark canvas (#0a0a0c) with #e11d48 accent used exclusively on primary actions. Product screenshots or interface mockups as the primary visual element. High contrast between surface (#surface) and text creates the premium feel characteristic of Teenage Engineering.
...
==================================================================
#0a0a0c  ->  page background, all section backgrounds
#e11d48  ->  primary CTA buttons, links on hover, focus rings, selected states, brand accents
#ffffff  ->  all headings (H1-H3), body text, primary UI labels
#1c1d22  ->  card surfaces, modal backgrounds, input field backgrounds
#30323a  ->  borders, dividers, separator lines — 1px only
#8a8d9b  ->  secondary body text, metadata, timestamps, captions
...
colors: { bg: '#0a0a0c', surface: '#1c1d22', accent: '#e11d48', primary: '#ffffff', muted: '#8a8d9b' }
...
4. RE-ENGINEER every UI component (nav, hero, cards, buttons, inputs, footer) into the Teenage Engineering visual language while keeping the user's real content, data, and workflows intact.
...
7. VERIFY: The output should feel unmistakably like Teenage Engineering's design aesthetic applied to the user's own project domain.
