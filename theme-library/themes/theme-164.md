# THEME #164 --- GitHub Universe

- **Website URL:** [https://githubuniverse.com/](https://githubuniverse.com/)
- **Category:** Developer / Infrastructure
- **Design Style:** Isometric Architectural Infrastructure
- **Mode:** dark
- **Tags:** `developer-infrastructure`, `light`, `developer`

---

## 🧬 Theme DNA Summary
> **GitHub Universe design DNA: Terminal windows, syntax highlighting, monospace metadata, hairline borders, and live developer CLI workflows.**

---

## 🔑 Signature Visual Element
Deep dark canvas (#030712) with #38bdf8 accent used exclusively on primary actions. Product screenshots or interface mockups as the primary visual element. High contrast between surface (#surface) and text creates the premium feel characteristic of GitHub Universe.

---

## 🎭 Emotional Intent
Technical precision and professional authority. The user feels GitHub Universe is built by people who understand their craft deeply. The dark aesthetic communicates focus, speed, and zero compromise on quality.

---

## 🎯 Design Principles ("Why does this look like this?")
Why GitHub Universe looks like this: Built for instant technical comprehension, zero latency, and engineering credibility.
...
- Developer platforms
- CI/CD tools
- GitHub Universe-inspired applications
...
## ❌ Things NOT To Copy
  * Proprietary GitHub Universe brand logos
  * Exact GitHub Universe copyrighted assets
...
Your task is to analyze the user's current project / objective, and TRANSFORM / REDESIGN its entire frontend style, visual aesthetic, UX feeling, and component architecture strictly using the design system DNA of THEME #164 (GitHub Universe - https://githubuniverse.com/).
...
2. TRANSLATE DESIGN DNA (DO NOT COPY PROPRIETARY CONTENT):
   - Do NOT blindly copy placeholder copy, trademarks, or unrelated product catalog from GitHub Universe (e.g., do not insert "GitHub Universe" branding or unrelated product listings).
   - DO extract and adopt 100% of GitHub Universe's visual craft, color palette, typography hierarchy, card structures, spacing rhythm, surface depth, micro-interactions, and UX feeling.

3. ELEVATE & RESKIN EVERY COMPONENT:
   - Reskin the user's existing components (navbars, heroes, product/feature cards, buttons, filters, inputs, modals, footers) into the authentic visual language of THEME #164.
   - Example: If the user's project is an apparel store selling shirts, design a high-craft shirt catalog with GitHub Universe's signature layouts, typography scale, lighting, and button styles.

==================================================================
🧬 THEME #164 IDENTITY & EMOTIONAL BRIEF
==================================================================
- Permanent Theme ID: THEME #164
- Reference Design Source: GitHub Universe (https://githubuniverse.com/)
- Mode: dark
- Archetype / Category: Developer / Infrastructure
- Design Style: Isometric Architectural Infrastructure
- Visual Personality: GitHub Universe signature design: isometric architectural infrastructure, engineered with high-craft aesthetics, structured hierarchy, and platform-native ergonomics.
- Core Design DNA: GitHub Universe design DNA: Terminal windows, syntax highlighting, monospace metadata, hairline borders, and live developer CLI workflows.

THE SIGNATURE VISUAL ELEMENT (What makes this theme unmistakably GitHub Universe):
Deep dark canvas (#030712) with #38bdf8 accent used exclusively on primary actions. Product screenshots or interface mockups as the primary visual element. High contrast between surface (#surface) and text creates the premium feel characteristic of GitHub Universe.
...
==================================================================
#030712  ->  page background, all section backgrounds
#38bdf8  ->  primary CTA buttons, links on hover, focus rings, selected states, brand accents
#f8fafc  ->  all headings (H1-H3), body text, primary UI labels
...
colors: { bg: '#030712', surface: '#111827', accent: '#38bdf8', primary: '#f8fafc', muted: '#94a3b8' }
...
4. RE-ENGINEER every UI component (nav, hero, cards, buttons, inputs, footer) into the GitHub Universe visual language while keeping the user's real content, data, and workflows intact.
...
7. VERIFY: The output should feel unmistakably like GitHub Universe's design aesthetic applied to the user's own project domain.
