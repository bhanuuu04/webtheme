# THEME #379 --- Van Cleef & Arpels

- **Website URL:** [https://www.vancleefarpels.com/](https://www.vancleefarpels.com/)
...
## 🧬 Theme DNA Summary
> **Van Cleef & Arpels design DNA: Exquisite serif typography, expansive ivory/obsidian whitespace, 3:4 lookbook imagery, and slow graceful transitions.**

---

## 🔑 Signature Visual Element
Deep dark canvas (#0c0c0c) with #d4af37 accent used exclusively on primary actions. Product screenshots or interface mockups as the primary visual element. High contrast between surface (#surface) and text creates the premium feel characteristic of Van Cleef & Arpels.

---

## 🎭 Emotional Intent
Technical precision and professional authority. The user feels Van Cleef & Arpels is built by people who understand their craft deeply. The dark aesthetic communicates focus, speed, and zero compromise on quality.

---

## 🎯 Design Principles ("Why does this look like this?")
Why Van Cleef & Arpels looks like this: Engineered to evoke timeless elegance, craftsmanship, exclusivity, and quiet luxury.
...
- Hospitality & resorts
- Fragrance & beauty
- Van Cleef & Arpels-inspired applications
...
## ❌ Things NOT To Copy
  * Proprietary Van Cleef & Arpels brand logos
  * Exact Van Cleef & Arpels copyrighted assets
...
Your task is to analyze the user's current project / objective, and TRANSFORM / REDESIGN its entire frontend style, visual aesthetic, UX feeling, and component architecture strictly using the design system DNA of THEME #379 (Van Cleef & Arpels - https://www.vancleefarpels.com/).
...
2. TRANSLATE DESIGN DNA (DO NOT COPY PROPRIETARY CONTENT):
   - Do NOT blindly copy placeholder copy, trademarks, or unrelated product catalog from Van Cleef & Arpels (e.g., do not insert "Van Cleef & Arpels" branding or unrelated product listings).
   - DO extract and adopt 100% of Van Cleef & Arpels's visual craft, color palette, typography hierarchy, card structures, spacing rhythm, surface depth, micro-interactions, and UX feeling.

3. ELEVATE & RESKIN EVERY COMPONENT:
   - Reskin the user's existing components (navbars, heroes, product/feature cards, buttons, filters, inputs, modals, footers) into the authentic visual language of THEME #379.
   - Example: If the user's project is an apparel store selling shirts, design a high-craft shirt catalog with Van Cleef & Arpels's signature layouts, typography scale, lighting, and button styles.

==================================================================
🧬 THEME #379 IDENTITY & EMOTIONAL BRIEF
==================================================================
- Permanent Theme ID: THEME #379
- Reference Design Source: Van Cleef & Arpels (https://www.vancleefarpels.com/)
- Mode: dark
- Archetype / Category: Luxury / Fashion
- Design Style: Dark Opulent Luxury Maison
- Visual Personality: Van Cleef & Arpels signature design: dark opulent luxury maison, engineered with high-craft aesthetics, structured hierarchy, and platform-native ergonomics.
- Core Design DNA: Van Cleef & Arpels design DNA: Exquisite serif typography, expansive ivory/obsidian whitespace, 3:4 lookbook imagery, and slow graceful transitions.

THE SIGNATURE VISUAL ELEMENT (What makes this theme unmistakably Van Cleef & Arpels):
Deep dark canvas (#0c0c0c) with #d4af37 accent used exclusively on primary actions. Product screenshots or interface mockups as the primary visual element. High contrast between surface (#surface) and text creates the premium feel characteristic of Van Cleef & Arpels.
...
4. RE-ENGINEER every UI component (nav, hero, cards, buttons, inputs, footer) into the Van Cleef & Arpels visual language while keeping the user's real content, data, and workflows intact.
...
7. VERIFY: The output should feel unmistakably like Van Cleef & Arpels's design aesthetic applied to the user's own project domain.
