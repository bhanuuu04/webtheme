# THEME #364 --- Stone Island

- **Website URL:** [https://www.stoneisland.com/](https://www.stoneisland.com/)
...
## 🧬 Theme DNA Summary
> **Stone Island design DNA: Exquisite serif typography, expansive ivory/obsidian whitespace, 3:4 lookbook imagery, and slow graceful transitions.**

---

## 🔑 Signature Visual Element
Clean white editorial canvas with #1a1818 as the single brand accent color. Large display typography and generous whitespace communicate the premium quality of Stone Island. Product screenshots or lifestyle imagery on clean white/off-white backgrounds.

---

## 🎭 Emotional Intent
Clarity and trustworthiness. The user feels confident that Stone Island is the right choice — professional, accessible, and purpose-built for their needs. The clean light design removes friction and communicates reliability.

---

## 🎯 Design Principles ("Why does this look like this?")
Why Stone Island looks like this: Engineered to evoke timeless elegance, craftsmanship, exclusivity, and quiet luxury.
...
- Hospitality & resorts
- Fragrance & beauty
- Stone Island-inspired applications
...
## ❌ Things NOT To Copy
  * Proprietary Stone Island brand logos
  * Exact Stone Island copyrighted assets
...
Your task is to analyze the user's current project / objective, and TRANSFORM / REDESIGN its entire frontend style, visual aesthetic, UX feeling, and component architecture strictly using the design system DNA of THEME #364 (Stone Island - https://www.stoneisland.com/).
...
2. TRANSLATE DESIGN DNA (DO NOT COPY PROPRIETARY CONTENT):
   - Do NOT blindly copy placeholder copy, trademarks, or unrelated product catalog from Stone Island (e.g., do not insert "Stone Island" branding or unrelated product listings).
   - DO extract and adopt 100% of Stone Island's visual craft, color palette, typography hierarchy, card structures, spacing rhythm, surface depth, micro-interactions, and UX feeling.

3. ELEVATE & RESKIN EVERY COMPONENT:
   - Reskin the user's existing components (navbars, heroes, product/feature cards, buttons, filters, inputs, modals, footers) into the authentic visual language of THEME #364.
   - Example: If the user's project is an apparel store selling shirts, design a high-craft shirt catalog with Stone Island's signature layouts, typography scale, lighting, and button styles.

==================================================================
🧬 THEME #364 IDENTITY & EMOTIONAL BRIEF
==================================================================
- Permanent Theme ID: THEME #364
- Reference Design Source: Stone Island (https://www.stoneisland.com/)
- Mode: light
- Archetype / Category: Luxury / Fashion
- Design Style: Warm Sunlit Atelier
- Visual Personality: Stone Island signature design: warm sunlit atelier, engineered with high-craft aesthetics, structured hierarchy, and platform-native ergonomics.
- Core Design DNA: Stone Island design DNA: Exquisite serif typography, expansive ivory/obsidian whitespace, 3:4 lookbook imagery, and slow graceful transitions.

THE SIGNATURE VISUAL ELEMENT (What makes this theme unmistakably Stone Island):
Clean white editorial canvas with #1a1818 as the single brand accent color. Large display typography and generous whitespace communicate the premium quality of Stone Island. Product screenshots or lifestyle imagery on clean white/off-white backgrounds.
...
4. RE-ENGINEER every UI component (nav, hero, cards, buttons, inputs, footer) into the Stone Island visual language while keeping the user's real content, data, and workflows intact.
...
7. VERIFY: The output should feel unmistakably like Stone Island's design aesthetic applied to the user's own project domain.
