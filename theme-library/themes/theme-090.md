# THEME #090 --- Microsoft AI

- **Website URL:** [https://www.microsoft.com/en-us/ai](https://www.microsoft.com/en-us/ai)
- **Category:** AI
- **Design Style:** Minimalist Prompt-First Canvas
- **Mode:** dark
- **Tags:** `ai`, `light`, `minimal`

---

## 🧬 Theme DNA Summary
> **Microsoft AI design DNA: Dark void canvas, iridescent neon glow accents, prompt-first conversational UI, and live generative canvas modules.**

---

## 🔑 Signature Visual Element
Deep dark canvas (#121113) with #f59e0b accent used exclusively on primary actions. Product screenshots or interface mockups as the primary visual element. High contrast between surface (#surface) and text creates the premium feel characteristic of Microsoft AI.

---

## 🎭 Emotional Intent
Technical precision and professional authority. The user feels Microsoft AI is built by people who understand their craft deeply. The dark aesthetic communicates focus, speed, and zero compromise on quality.

---

## 🎯 Design Principles ("Why does this look like this?")
Why Microsoft AI looks like this: Engineered to evoke machine intelligence, boundless creativity, and real-time generative wonder.
...
- Model playgrounds
- Microsoft AI-inspired applications
- AI platforms
...
## ❌ Things NOT To Copy
  * Proprietary Microsoft AI brand logos
  * Exact Microsoft AI copyrighted assets
...
Your task is to analyze the user's current project / objective, and TRANSFORM / REDESIGN its entire frontend style, visual aesthetic, UX feeling, and component architecture strictly using the design system DNA of THEME #090 (Microsoft AI - https://www.microsoft.com/en-us/ai).
...
2. TRANSLATE DESIGN DNA (DO NOT COPY PROPRIETARY CONTENT):
   - Do NOT blindly copy placeholder copy, trademarks, or unrelated product catalog from Microsoft AI (e.g., do not insert "Microsoft AI" branding or unrelated product listings).
   - DO extract and adopt 100% of Microsoft AI's visual craft, color palette, typography hierarchy, card structures, spacing rhythm, surface depth, micro-interactions, and UX feeling.

3. ELEVATE & RESKIN EVERY COMPONENT:
   - Reskin the user's existing components (navbars, heroes, product/feature cards, buttons, filters, inputs, modals, footers) into the authentic visual language of THEME #090.
   - Example: If the user's project is an apparel store selling shirts, design a high-craft shirt catalog with Microsoft AI's signature layouts, typography scale, lighting, and button styles.

==================================================================
🧬 THEME #090 IDENTITY & EMOTIONAL BRIEF
==================================================================
- Permanent Theme ID: THEME #090
- Reference Design Source: Microsoft AI (https://www.microsoft.com/en-us/ai)
- Mode: dark
- Archetype / Category: AI
- Design Style: Minimalist Prompt-First Canvas
- Visual Personality: Microsoft AI signature design: minimalist prompt-first canvas, engineered with high-craft aesthetics, structured hierarchy, and platform-native ergonomics.
- Core Design DNA: Microsoft AI design DNA: Dark void canvas, iridescent neon glow accents, prompt-first conversational UI, and live generative canvas modules.

THE SIGNATURE VISUAL ELEMENT (What makes this theme unmistakably Microsoft AI):
Deep dark canvas (#121113) with #f59e0b accent used exclusively on primary actions. Product screenshots or interface mockups as the primary visual element. High contrast between surface (#surface) and text creates the premium feel characteristic of Microsoft AI.
...
colors: { bg: '#121113', surface: '#18181b', accent: '#f59e0b', primary: '#fafafa', muted: '#71717a' }
...
4. RE-ENGINEER every UI component (nav, hero, cards, buttons, inputs, footer) into the Microsoft AI visual language while keeping the user's real content, data, and workflows intact.
...
7. VERIFY: The output should feel unmistakably like Microsoft AI's design aesthetic applied to the user's own project domain.
