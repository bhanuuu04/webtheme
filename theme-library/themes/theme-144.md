...
- **Website URL:** [https://mantine.dev/](https://mantine.dev/)
...
## 🧬 Theme DNA Summary
> **Mantine design DNA: Terminal windows, syntax highlighting, monospace metadata, hairline borders, and live developer CLI workflows.**

---

## 🔑 Signature Visual Element
Deep dark canvas (#030712) with #38bdf8 accent used exclusively on primary actions. Product screenshots or interface mockups as the primary visual element. High contrast between surface (#surface) and text creates the premium feel characteristic of Mantine.

---

## 🎭 Emotional Intent
Technical precision and professional authority. The user feels Mantine is built by people who understand their craft deeply. The dark aesthetic communicates focus, speed, and zero compromise on quality.

---

## 🎯 Design Principles ("Why does this look like this?")
Why Mantine looks like this: Built for instant technical comprehension, zero latency, and engineering credibility.
...
## ❌ Things NOT To Copy
  * Proprietary Mantine brand logos
  * Exact Mantine copyrighted assets
...
Your task is to analyze the user's current project / objective, and TRANSFORM / REDESIGN its entire frontend style, visual aesthetic, UX feeling, and component architecture strictly using the design system DNA of THEME #144 (Mantine - https://mantine.dev/).
...
2. TRANSLATE DESIGN DNA (DO NOT COPY PROPRIETARY CONTENT):
   - Do NOT blindly copy placeholder copy, trademarks, or unrelated product catalog from Mantine (e.g., do not insert "Mantine" branding or unrelated product listings).
   - DO extract and adopt 100% of Mantine's visual craft, color palette, typography hierarchy, card structures, spacing rhythm, surface depth, micro-interactions, and UX feeling.

3. ELEVATE & RESKIN EVERY COMPONENT:
   - Reskin the user's existing components (navbars, heroes, product/feature cards, buttons, filters, inputs, modals, footers) into the authentic visual language of THEME #144.
   - Example: If the user's project is an apparel store selling shirts, design a high-craft shirt catalog with Mantine's signature layouts, typography scale, lighting, and button styles.

==================================================================
🧬 THEME #144 IDENTITY & EMOTIONAL BRIEF
==================================================================
- Permanent Theme ID: THEME #144
- Reference Design Source: Mantine (https://mantine.dev/)
- Mode: dark
- Archetype / Category: Developer / Infrastructure
- Design Style: Monospace Minimalist CLI Hub
- Visual Personality: Mantine signature design: monospace minimalist cli hub, engineered with high-craft aesthetics, structured hierarchy, and platform-native ergonomics.
- Core Design DNA: Mantine design DNA: Terminal windows, syntax highlighting, monospace metadata, hairline borders, and live developer CLI workflows.

THE SIGNATURE VISUAL ELEMENT (What makes this theme unmistakably Mantine):
Deep dark canvas (#030712) with #38bdf8 accent used exclusively on primary actions. Product screenshots or interface mockups as the primary visual element. High contrast between surface (#surface) and text creates the premium feel characteristic of Mantine.
...
4. RE-ENGINEER every UI component (nav, hero, cards, buttons, inputs, footer) into the Mantine visual language while keeping the user's real content, data, and workflows intact.
...
7. VERIFY: The output should feel unmistakably like Mantine's design aesthetic applied to the user's own project domain.
