...
- **Website URL:** [https://www.shadertoy.com/](https://www.shadertoy.com/)
...
## 🧬 Theme DNA Summary
> **ShaderToy design DNA: Full-bleed WebGL 3D canvas, corner HUD interface layout, kinetic typography, magnetic cursor, and spatial physics.**

---

## 🔑 Signature Visual Element
Deep dark canvas (#000000) with #ff3366 accent used exclusively on primary actions. Product screenshots or interface mockups as the primary visual element. High contrast between surface (#surface) and text creates the premium feel characteristic of ShaderToy.

---

## 🎭 Emotional Intent
Technical precision and professional authority. The user feels ShaderToy is built by people who understand their craft deeply. The dark aesthetic communicates focus, speed, and zero compromise on quality.

---

## 🎯 Design Principles ("Why does this look like this?")
Why ShaderToy looks like this: Engineered to deliver unforgettable tactile immersion, technological awe, and cutting-edge craft.
...
- Luxury concepts
- ShaderToy-inspired applications
...
## ❌ Things NOT To Copy
  * Proprietary ShaderToy brand logos
  * Exact ShaderToy copyrighted assets
...
Your task is to analyze the user's current project / objective, and TRANSFORM / REDESIGN its entire frontend style, visual aesthetic, UX feeling, and component architecture strictly using the design system DNA of THEME #247 (ShaderToy - https://www.shadertoy.com/).
...
2. TRANSLATE DESIGN DNA (DO NOT COPY PROPRIETARY CONTENT):
   - Do NOT blindly copy placeholder copy, trademarks, or unrelated product catalog from ShaderToy (e.g., do not insert "ShaderToy" branding or unrelated product listings).
   - DO extract and adopt 100% of ShaderToy's visual craft, color palette, typography hierarchy, card structures, spacing rhythm, surface depth, micro-interactions, and UX feeling.

3. ELEVATE & RESKIN EVERY COMPONENT:
   - Reskin the user's existing components (navbars, heroes, product/feature cards, buttons, filters, inputs, modals, footers) into the authentic visual language of THEME #247.
   - Example: If the user's project is an apparel store selling shirts, design a high-craft shirt catalog with ShaderToy's signature layouts, typography scale, lighting, and button styles.

==================================================================
🧬 THEME #247 IDENTITY & EMOTIONAL BRIEF
==================================================================
- Permanent Theme ID: THEME #247
- Reference Design Source: ShaderToy (https://www.shadertoy.com/)
- Mode: dark
- Archetype / Category: 3D / WebGL / Immersive
- Design Style: Kinetic Physics Playground
- Visual Personality: ShaderToy signature design: kinetic physics playground, engineered with high-craft aesthetics, structured hierarchy, and platform-native ergonomics.
- Core Design DNA: ShaderToy design DNA: Full-bleed WebGL 3D canvas, corner HUD interface layout, kinetic typography, magnetic cursor, and spatial physics.

THE SIGNATURE VISUAL ELEMENT (What makes this theme unmistakably ShaderToy):
Deep dark canvas (#000000) with #ff3366 accent used exclusively on primary actions. Product screenshots or interface mockups as the primary visual element. High contrast between surface (#surface) and text creates the premium feel characteristic of ShaderToy.
...
4. RE-ENGINEER every UI component (nav, hero, cards, buttons, inputs, footer) into the ShaderToy visual language while keeping the user's real content, data, and workflows intact.
...
7. VERIFY: The output should feel unmistakably like ShaderToy's design aesthetic applied to the user's own project domain.
