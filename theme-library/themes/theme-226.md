...
- **Website URL:** [https://onmi.com/](https://onmi.com/)
...
## 🧬 Theme DNA Summary
> **Onmi design DNA: Full-bleed WebGL 3D canvas, corner HUD interface layout, kinetic typography, magnetic cursor, and spatial physics.**

---

## 🔑 Signature Visual Element
Deep dark canvas (#080810) with #6366f1 accent used exclusively on primary actions. Product screenshots or interface mockups as the primary visual element. High contrast between surface (#surface) and text creates the premium feel characteristic of Onmi.

---

## 🎭 Emotional Intent
Technical precision and professional authority. The user feels Onmi is built by people who understand their craft deeply. The dark aesthetic communicates focus, speed, and zero compromise on quality.

---

## 🎯 Design Principles ("Why does this look like this?")
Why Onmi looks like this: Engineered to deliver unforgettable tactile immersion, technological awe, and cutting-edge craft.
...
## ❌ Things NOT To Copy
  * Proprietary Onmi brand logos
  * Exact Onmi copyrighted assets
...
Your task is to analyze the user's current project / objective, and TRANSFORM / REDESIGN its entire frontend style, visual aesthetic, UX feeling, and component architecture strictly using the design system DNA of THEME #226 (Onmi - https://onmi.com/).
...
2. TRANSLATE DESIGN DNA (DO NOT COPY PROPRIETARY CONTENT):
   - Do NOT blindly copy placeholder copy, trademarks, or unrelated product catalog from Onmi (e.g., do not insert "Onmi" branding or unrelated product listings).
   - DO extract and adopt 100% of Onmi's visual craft, color palette, typography hierarchy, card structures, spacing rhythm, surface depth, micro-interactions, and UX feeling.

3. ELEVATE & RESKIN EVERY COMPONENT:
   - Reskin the user's existing components (navbars, heroes, product/feature cards, buttons, filters, inputs, modals, footers) into the authentic visual language of THEME #226.
   - Example: If the user's project is an apparel store selling shirts, design a high-craft shirt catalog with Onmi's signature layouts, typography scale, lighting, and button styles.

==================================================================
🧬 THEME #226 IDENTITY & EMOTIONAL BRIEF
==================================================================
- Permanent Theme ID: THEME #226
- Reference Design Source: Onmi (https://onmi.com/)
- Mode: dark
- Archetype / Category: 3D / WebGL / Immersive
- Design Style: Dark Cybernetic 3D Realm
- Visual Personality: Onmi signature design: dark cybernetic 3d realm, engineered with high-craft aesthetics, structured hierarchy, and platform-native ergonomics.
- Core Design DNA: Onmi design DNA: Full-bleed WebGL 3D canvas, corner HUD interface layout, kinetic typography, magnetic cursor, and spatial physics.

THE SIGNATURE VISUAL ELEMENT (What makes this theme unmistakably Onmi):
Deep dark canvas (#080810) with #6366f1 accent used exclusively on primary actions. Product screenshots or interface mockups as the primary visual element. High contrast between surface (#surface) and text creates the premium feel characteristic of Onmi.
...
4. RE-ENGINEER every UI component (nav, hero, cards, buttons, inputs, footer) into the Onmi visual language while keeping the user's real content, data, and workflows intact.
...
7. VERIFY: The output should feel unmistakably like Onmi's design aesthetic applied to the user's own project domain.
