...
- **Website URL:** [https://httpster.net/](https://httpster.net/)
...
## 🧬 Theme DNA Summary
> **Httpster design DNA: Kinetic spring physics, interactive dragging elements, playful typography transforms, and scroll-pinned storytelling.**

---

## 🔑 Signature Visual Element
Clean white editorial canvas with #18181b as the single brand accent color. Large display typography and generous whitespace communicate the premium quality of Httpster. Product screenshots or lifestyle imagery on clean white/off-white backgrounds.

---

## 🎭 Emotional Intent
Clarity and trustworthiness. The user feels confident that Httpster is the right choice — professional, accessible, and purpose-built for their needs. The clean light design removes friction and communicates reliability.

---

## 🎯 Design Principles ("Why does this look like this?")
Why Httpster looks like this: Engineered to reward user curiosity, delight through micro-interactions, and make software feel alive.
...
- Mobile apps
- Consumer portfolios
- Httpster-inspired applications
...
## ❌ Things NOT To Copy
  * Proprietary Httpster brand logos
  * Exact Httpster copyrighted assets
...
Your task is to analyze the user's current project / objective, and TRANSFORM / REDESIGN its entire frontend style, visual aesthetic, UX feeling, and component architecture strictly using the design system DNA of THEME #272 (Httpster - https://httpster.net/).
...
2. TRANSLATE DESIGN DNA (DO NOT COPY PROPRIETARY CONTENT):
   - Do NOT blindly copy placeholder copy, trademarks, or unrelated product catalog from Httpster (e.g., do not insert "Httpster" branding or unrelated product listings).
   - DO extract and adopt 100% of Httpster's visual craft, color palette, typography hierarchy, card structures, spacing rhythm, surface depth, micro-interactions, and UX feeling.

3. ELEVATE & RESKIN EVERY COMPONENT:
   - Reskin the user's existing components (navbars, heroes, product/feature cards, buttons, filters, inputs, modals, footers) into the authentic visual language of THEME #272.
   - Example: If the user's project is an apparel store selling shirts, design a high-craft shirt catalog with Httpster's signature layouts, typography scale, lighting, and button styles.

==================================================================
🧬 THEME #272 IDENTITY & EMOTIONAL BRIEF
==================================================================
- Permanent Theme ID: THEME #272
- Reference Design Source: Httpster (https://httpster.net/)
- Mode: light
- Archetype / Category: Motion / Interaction
- Design Style: Scroll-Driven Interactive Story
- Visual Personality: Httpster signature design: scroll-driven interactive story, engineered with high-craft aesthetics, structured hierarchy, and platform-native ergonomics.
- Core Design DNA: Httpster design DNA: Kinetic spring physics, interactive dragging elements, playful typography transforms, and scroll-pinned storytelling.

THE SIGNATURE VISUAL ELEMENT (What makes this theme unmistakably Httpster):
Clean white editorial canvas with #18181b as the single brand accent color. Large display typography and generous whitespace communicate the premium quality of Httpster. Product screenshots or lifestyle imagery on clean white/off-white backgrounds.
...
4. RE-ENGINEER every UI component (nav, hero, cards, buttons, inputs, footer) into the Httpster visual language while keeping the user's real content, data, and workflows intact.
...
7. VERIFY: The output should feel unmistakably like Httpster's design aesthetic applied to the user's own project domain.
