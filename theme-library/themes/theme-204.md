...
- **Website URL:** [https://www.kraken.com/](https://www.kraken.com/)
...
## 🧬 Theme DNA Summary
> **Kraken design DNA: High-trust typography, dynamic financial metric counters, virtual debit card mockups, and regulatory rigor.**

---

## 🔑 Signature Visual Element
Clean white editorial canvas with #0284c7 as the single brand accent color. Large display typography and generous whitespace communicate the premium quality of Kraken. Product screenshots or lifestyle imagery on clean white/off-white backgrounds.

---

## 🎭 Emotional Intent
Clarity and trustworthiness. The user feels confident that Kraken is the right choice — professional, accessible, and purpose-built for their needs. The clean light design removes friction and communicates reliability.

---

## 🎯 Design Principles ("Why does this look like this?")
Why Kraken looks like this: Engineered to project absolute security, frictionless capital flow, and financial empowerment.
...
## ❌ Things NOT To Copy
  * Proprietary Kraken brand logos
  * Exact Kraken copyrighted assets
...
Your task is to analyze the user's current project / objective, and TRANSFORM / REDESIGN its entire frontend style, visual aesthetic, UX feeling, and component architecture strictly using the design system DNA of THEME #204 (Kraken - https://www.kraken.com/).
...
2. TRANSLATE DESIGN DNA (DO NOT COPY PROPRIETARY CONTENT):
   - Do NOT blindly copy placeholder copy, trademarks, or unrelated product catalog from Kraken (e.g., do not insert "Kraken" branding or unrelated product listings).
   - DO extract and adopt 100% of Kraken's visual craft, color palette, typography hierarchy, card structures, spacing rhythm, surface depth, micro-interactions, and UX feeling.

3. ELEVATE & RESKIN EVERY COMPONENT:
   - Reskin the user's existing components (navbars, heroes, product/feature cards, buttons, filters, inputs, modals, footers) into the authentic visual language of THEME #204.
   - Example: If the user's project is an apparel store selling shirts, design a high-craft shirt catalog with Kraken's signature layouts, typography scale, lighting, and button styles.

==================================================================
🧬 THEME #204 IDENTITY & EMOTIONAL BRIEF
==================================================================
- Permanent Theme ID: THEME #204
- Reference Design Source: Kraken (https://www.kraken.com/)
- Mode: light
- Archetype / Category: Fintech / Finance
- Design Style: Sleek Wealth Management
- Visual Personality: Kraken signature design: sleek wealth management, engineered with high-craft aesthetics, structured hierarchy, and platform-native ergonomics.
- Core Design DNA: Kraken design DNA: High-trust typography, dynamic financial metric counters, virtual debit card mockups, and regulatory rigor.

THE SIGNATURE VISUAL ELEMENT (What makes this theme unmistakably Kraken):
Clean white editorial canvas with #0284c7 as the single brand accent color. Large display typography and generous whitespace communicate the premium quality of Kraken. Product screenshots or lifestyle imagery on clean white/off-white backgrounds.
...
4. RE-ENGINEER every UI component (nav, hero, cards, buttons, inputs, footer) into the Kraken visual language while keeping the user's real content, data, and workflows intact.
...
7. VERIFY: The output should feel unmistakably like Kraken's design aesthetic applied to the user's own project domain.
