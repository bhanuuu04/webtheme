# THEME #408 --- Koenigsegg

- **Website URL:** [https://www.koenigsegg.com/](https://www.koenigsegg.com/)
...
## 🧬 Theme DNA Summary
> **Koenigsegg design DNA: Matte carbon textures, telemetry spec dials, 360 configurator controls, chamfered components, and industrial precision.**

---

## 🔑 Signature Visual Element
Deep dark canvas (#111215) with #00d2ff accent used exclusively on primary actions. Product screenshots or interface mockups as the primary visual element. High contrast between surface (#surface) and text creates the premium feel characteristic of Koenigsegg.

---

## 🎭 Emotional Intent
Technical precision and professional authority. The user feels Koenigsegg is built by people who understand their craft deeply. The dark aesthetic communicates focus, speed, and zero compromise on quality.

---

## 🎯 Design Principles ("Why does this look like this?")
Why Koenigsegg looks like this: Engineered to communicate sheer performance, mechanical mastery, aerodynamic speed, and premium craft.
...
- Industrial design
- Aerospace
- Koenigsegg-inspired applications
...
## ❌ Things NOT To Copy
  * Proprietary Koenigsegg brand logos
  * Exact Koenigsegg copyrighted assets
...
Your task is to analyze the user's current project / objective, and TRANSFORM / REDESIGN its entire frontend style, visual aesthetic, UX feeling, and component architecture strictly using the design system DNA of THEME #408 (Koenigsegg - https://www.koenigsegg.com/).
...
2. TRANSLATE DESIGN DNA (DO NOT COPY PROPRIETARY CONTENT):
   - Do NOT blindly copy placeholder copy, trademarks, or unrelated product catalog from Koenigsegg (e.g., do not insert "Koenigsegg" branding or unrelated product listings).
   - DO extract and adopt 100% of Koenigsegg's visual craft, color palette, typography hierarchy, card structures, spacing rhythm, surface depth, micro-interactions, and UX feeling.

3. ELEVATE & RESKIN EVERY COMPONENT:
   - Reskin the user's existing components (navbars, heroes, product/feature cards, buttons, filters, inputs, modals, footers) into the authentic visual language of THEME #408.
   - Example: If the user's project is an apparel store selling shirts, design a high-craft shirt catalog with Koenigsegg's signature layouts, typography scale, lighting, and button styles.

==================================================================
🧬 THEME #408 IDENTITY & EMOTIONAL BRIEF
==================================================================
- Permanent Theme ID: THEME #408
- Reference Design Source: Koenigsegg (https://www.koenigsegg.com/)
- Mode: dark
- Archetype / Category: Automotive / Product
- Design Style: Futuristic EV Digital Cockpit
- Visual Personality: Koenigsegg signature design: futuristic ev digital cockpit, engineered with high-craft aesthetics, structured hierarchy, and platform-native ergonomics.
- Core Design DNA: Koenigsegg design DNA: Matte carbon textures, telemetry spec dials, 360 configurator controls, chamfered components, and industrial precision.

THE SIGNATURE VISUAL ELEMENT (What makes this theme unmistakably Koenigsegg):
Deep dark canvas (#111215) with #00d2ff accent used exclusively on primary actions. Product screenshots or interface mockups as the primary visual element. High contrast between surface (#surface) and text creates the premium feel characteristic of Koenigsegg.
...
4. RE-ENGINEER every UI component (nav, hero, cards, buttons, inputs, footer) into the Koenigsegg visual language while keeping the user's real content, data, and workflows intact.
...
7. VERIFY: The output should feel unmistakably like Koenigsegg's design aesthetic applied to the user's own project domain.
