# THEME #458 --- Aime Leon Dore

- **Website URL:** [https://www.aimeleondore.com/](https://www.aimeleondore.com/)
- **Category:** E-commerce / Consumer
- **Design Style:** Minimalist Clean Curation
- **Mode:** light
- **Tags:** `e-commerce-consumer`, `light`, `minimal`, `ai`

---

## 🧬 Theme DNA Summary
> **Aime Leon Dore design DNA: Product shelf grids, secondary hover image flips, instant slide-over cart drawer, and high-contrast Add to Cart CTA.**

---

## 🔑 Signature Visual Element
Clean white editorial canvas with #27272a as the single brand accent color. Large display typography and generous whitespace communicate the premium quality of Aime Leon Dore. Product screenshots or lifestyle imagery on clean white/off-white backgrounds.

---

## 🎭 Emotional Intent
Clarity and trustworthiness. The user feels confident that Aime Leon Dore is the right choice — professional, accessible, and purpose-built for their needs. The clean light design removes friction and communicates reliability.

---

## 🎯 Design Principles ("Why does this look like this?")
Why Aime Leon Dore looks like this: Engineered to maximize product desirability, minimize checkout friction, and convey brand lifestyle authenticity.
...
- Subscription boxes
- Aime Leon Dore-inspired applications
...
## ❌ Things NOT To Copy
  * Proprietary Aime Leon Dore brand logos
  * Exact Aime Leon Dore copyrighted assets
...
Your task is to analyze the user's current project / objective, and TRANSFORM / REDESIGN its entire frontend style, visual aesthetic, UX feeling, and component architecture strictly using the design system DNA of THEME #458 (Aime Leon Dore - https://www.aimeleondore.com/).
...
2. TRANSLATE DESIGN DNA (DO NOT COPY PROPRIETARY CONTENT):
   - Do NOT blindly copy placeholder copy, trademarks, or unrelated product catalog from Aime Leon Dore (e.g., do not insert "Aime Leon Dore" branding or unrelated product listings).
   - DO extract and adopt 100% of Aime Leon Dore's visual craft, color palette, typography hierarchy, card structures, spacing rhythm, surface depth, micro-interactions, and UX feeling.

3. ELEVATE & RESKIN EVERY COMPONENT:
   - Reskin the user's existing components (navbars, heroes, product/feature cards, buttons, filters, inputs, modals, footers) into the authentic visual language of THEME #458.
   - Example: If the user's project is an apparel store selling shirts, design a high-craft shirt catalog with Aime Leon Dore's signature layouts, typography scale, lighting, and button styles.

==================================================================
🧬 THEME #458 IDENTITY & EMOTIONAL BRIEF
==================================================================
- Permanent Theme ID: THEME #458
- Reference Design Source: Aime Leon Dore (https://www.aimeleondore.com/)
- Mode: light
- Archetype / Category: E-commerce / Consumer
- Design Style: Minimalist Clean Curation
- Visual Personality: Aime Leon Dore signature design: minimalist clean curation, engineered with high-craft aesthetics, structured hierarchy, and platform-native ergonomics.
- Core Design DNA: Aime Leon Dore design DNA: Product shelf grids, secondary hover image flips, instant slide-over cart drawer, and high-contrast Add to Cart CTA.

THE SIGNATURE VISUAL ELEMENT (What makes this theme unmistakably Aime Leon Dore):
Clean white editorial canvas with #27272a as the single brand accent color. Large display typography and generous whitespace communicate the premium quality of Aime Leon Dore. Product screenshots or lifestyle imagery on clean white/off-white backgrounds.
...
4. RE-ENGINEER every UI component (nav, hero, cards, buttons, inputs, footer) into the Aime Leon Dore visual language while keeping the user's real content, data, and workflows intact.
...
7. VERIFY: The output should feel unmistakably like Aime Leon Dore's design aesthetic applied to the user's own project domain.
