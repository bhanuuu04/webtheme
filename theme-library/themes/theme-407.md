# THEME #407 --- Aston Martin

- **Website URL:** [https://www.astonmartin.com/](https://www.astonmartin.com/)
...
## 🧬 Theme DNA Summary
> **Aston Martin design DNA: Matte carbon textures, telemetry spec dials, 360 configurator controls, chamfered components, and industrial precision.**

---

## 🔑 Signature Visual Element
Deep dark canvas (#0a0a0c) with #e11d48 accent used exclusively on primary actions. Product screenshots or interface mockups as the primary visual element. High contrast between surface (#surface) and text creates the premium feel characteristic of Aston Martin.

---

## 🎭 Emotional Intent
Technical precision and professional authority. The user feels Aston Martin is built by people who understand their craft deeply. The dark aesthetic communicates focus, speed, and zero compromise on quality.

---

## 🎯 Design Principles ("Why does this look like this?")
Why Aston Martin looks like this: Engineered to communicate sheer performance, mechanical mastery, aerodynamic speed, and premium craft.
...
- Industrial design
- Aerospace
- Aston Martin-inspired applications
...
## ❌ Things NOT To Copy
  * Proprietary Aston Martin brand logos
  * Exact Aston Martin copyrighted assets
...
Your task is to analyze the user's current project / objective, and TRANSFORM / REDESIGN its entire frontend style, visual aesthetic, UX feeling, and component architecture strictly using the design system DNA of THEME #407 (Aston Martin - https://www.astonmartin.com/).
...
2. TRANSLATE DESIGN DNA (DO NOT COPY PROPRIETARY CONTENT):
   - Do NOT blindly copy placeholder copy, trademarks, or unrelated product catalog from Aston Martin (e.g., do not insert "Aston Martin" branding or unrelated product listings).
   - DO extract and adopt 100% of Aston Martin's visual craft, color palette, typography hierarchy, card structures, spacing rhythm, surface depth, micro-interactions, and UX feeling.

3. ELEVATE & RESKIN EVERY COMPONENT:
   - Reskin the user's existing components (navbars, heroes, product/feature cards, buttons, filters, inputs, modals, footers) into the authentic visual language of THEME #407.
   - Example: If the user's project is an apparel store selling shirts, design a high-craft shirt catalog with Aston Martin's signature layouts, typography scale, lighting, and button styles.

==================================================================
🧬 THEME #407 IDENTITY & EMOTIONAL BRIEF
==================================================================
- Permanent Theme ID: THEME #407
- Reference Design Source: Aston Martin (https://www.astonmartin.com/)
- Mode: dark
- Archetype / Category: Automotive / Product
- Design Style: Industrial Precision Hardware
- Visual Personality: Aston Martin signature design: industrial precision hardware, engineered with high-craft aesthetics, structured hierarchy, and platform-native ergonomics.
- Core Design DNA: Aston Martin design DNA: Matte carbon textures, telemetry spec dials, 360 configurator controls, chamfered components, and industrial precision.

THE SIGNATURE VISUAL ELEMENT (What makes this theme unmistakably Aston Martin):
Deep dark canvas (#0a0a0c) with #e11d48 accent used exclusively on primary actions. Product screenshots or interface mockups as the primary visual element. High contrast between surface (#surface) and text creates the premium feel characteristic of Aston Martin.
...
4. RE-ENGINEER every UI component (nav, hero, cards, buttons, inputs, footer) into the Aston Martin visual language while keeping the user's real content, data, and workflows intact.
...
7. VERIFY: The output should feel unmistakably like Aston Martin's design aesthetic applied to the user's own project domain.
