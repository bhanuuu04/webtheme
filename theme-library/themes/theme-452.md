...
- **Website URL:** [https://www.everlane.com/](https://www.everlane.com/)
...
## 🧬 Theme DNA Summary
> **Everlane design DNA: Product shelf grids, secondary hover image flips, instant slide-over cart drawer, and high-contrast Add to Cart CTA.**

---

## 🔑 Signature Visual Element
Clean white editorial canvas with #27272a as the single brand accent color. Large display typography and generous whitespace communicate the premium quality of Everlane. Product screenshots or lifestyle imagery on clean white/off-white backgrounds.

---

## 🎭 Emotional Intent
Clarity and trustworthiness. The user feels confident that Everlane is the right choice — professional, accessible, and purpose-built for their needs. The clean light design removes friction and communicates reliability.

---

## 🎯 Design Principles ("Why does this look like this?")
Why Everlane looks like this: Engineered to maximize product desirability, minimize checkout friction, and convey brand lifestyle authenticity.
...
- Subscription boxes
- Everlane-inspired applications
...
## ❌ Things NOT To Copy
  * Proprietary Everlane brand logos
  * Exact Everlane copyrighted assets
...
Your task is to analyze the user's current project / objective, and TRANSFORM / REDESIGN its entire frontend style, visual aesthetic, UX feeling, and component architecture strictly using the design system DNA of THEME #452 (Everlane - https://www.everlane.com/).
...
2. TRANSLATE DESIGN DNA (DO NOT COPY PROPRIETARY CONTENT):
   - Do NOT blindly copy placeholder copy, trademarks, or unrelated product catalog from Everlane (e.g., do not insert "Everlane" branding or unrelated product listings).
   - DO extract and adopt 100% of Everlane's visual craft, color palette, typography hierarchy, card structures, spacing rhythm, surface depth, micro-interactions, and UX feeling.

3. ELEVATE & RESKIN EVERY COMPONENT:
   - Reskin the user's existing components (navbars, heroes, product/feature cards, buttons, filters, inputs, modals, footers) into the authentic visual language of THEME #452.
   - Example: If the user's project is an apparel store selling shirts, design a high-craft shirt catalog with Everlane's signature layouts, typography scale, lighting, and button styles.

==================================================================
🧬 THEME #452 IDENTITY & EMOTIONAL BRIEF
==================================================================
- Permanent Theme ID: THEME #452
- Reference Design Source: Everlane (https://www.everlane.com/)
- Mode: light
- Archetype / Category: E-commerce / Consumer
- Design Style: Minimalist Clean Curation
- Visual Personality: Everlane signature design: minimalist clean curation, engineered with high-craft aesthetics, structured hierarchy, and platform-native ergonomics.
- Core Design DNA: Everlane design DNA: Product shelf grids, secondary hover image flips, instant slide-over cart drawer, and high-contrast Add to Cart CTA.

THE SIGNATURE VISUAL ELEMENT (What makes this theme unmistakably Everlane):
Clean white editorial canvas with #27272a as the single brand accent color. Large display typography and generous whitespace communicate the premium quality of Everlane. Product screenshots or lifestyle imagery on clean white/off-white backgrounds.
...
4. RE-ENGINEER every UI component (nav, hero, cards, buttons, inputs, footer) into the Everlane visual language while keeping the user's real content, data, and workflows intact.
...
7. VERIFY: The output should feel unmistakably like Everlane's design aesthetic applied to the user's own project domain.
