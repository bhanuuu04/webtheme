# THEME #225 --- WebGL Awards

- **Website URL:** [https://www.webdesignawards.io/technology/webgl](https://www.webdesignawards.io/technology/webgl)
...
## 🧬 Theme DNA Summary
> **WebGL Awards design DNA: Full-bleed WebGL 3D canvas, corner HUD interface layout, kinetic typography, magnetic cursor, and spatial physics.**

---

## 🔑 Signature Visual Element
Deep dark canvas (#000000) with #ff3366 accent used exclusively on primary actions. Product screenshots or interface mockups as the primary visual element. High contrast between surface (#surface) and text creates the premium feel characteristic of WebGL Awards.

---

## 🎭 Emotional Intent
Technical precision and professional authority. The user feels WebGL Awards is built by people who understand their craft deeply. The dark aesthetic communicates focus, speed, and zero compromise on quality.

---

## 🎯 Design Principles ("Why does this look like this?")
Why WebGL Awards looks like this: Engineered to deliver unforgettable tactile immersion, technological awe, and cutting-edge craft.
...
- Luxury concepts
- WebGL Awards-inspired applications
...
## ❌ Things NOT To Copy
  * Proprietary WebGL Awards brand logos
  * Exact WebGL Awards copyrighted assets
...
Your task is to analyze the user's current project / objective, and TRANSFORM / REDESIGN its entire frontend style, visual aesthetic, UX feeling, and component architecture strictly using the design system DNA of THEME #225 (WebGL Awards - https://www.webdesignawards.io/technology/webgl).
...
2. TRANSLATE DESIGN DNA (DO NOT COPY PROPRIETARY CONTENT):
   - Do NOT blindly copy placeholder copy, trademarks, or unrelated product catalog from WebGL Awards (e.g., do not insert "WebGL Awards" branding or unrelated product listings).
   - DO extract and adopt 100% of WebGL Awards's visual craft, color palette, typography hierarchy, card structures, spacing rhythm, surface depth, micro-interactions, and UX feeling.

3. ELEVATE & RESKIN EVERY COMPONENT:
   - Reskin the user's existing components (navbars, heroes, product/feature cards, buttons, filters, inputs, modals, footers) into the authentic visual language of THEME #225.
   - Example: If the user's project is an apparel store selling shirts, design a high-craft shirt catalog with WebGL Awards's signature layouts, typography scale, lighting, and button styles.

==================================================================
🧬 THEME #225 IDENTITY & EMOTIONAL BRIEF
==================================================================
- Permanent Theme ID: THEME #225
- Reference Design Source: WebGL Awards (https://www.webdesignawards.io/technology/webgl)
- Mode: dark
- Archetype / Category: 3D / WebGL / Immersive
- Design Style: Interactive WebGL Spatial Experience
- Visual Personality: WebGL Awards signature design: interactive webgl spatial experience, engineered with high-craft aesthetics, structured hierarchy, and platform-native ergonomics.
- Core Design DNA: WebGL Awards design DNA: Full-bleed WebGL 3D canvas, corner HUD interface layout, kinetic typography, magnetic cursor, and spatial physics.

THE SIGNATURE VISUAL ELEMENT (What makes this theme unmistakably WebGL Awards):
Deep dark canvas (#000000) with #ff3366 accent used exclusively on primary actions. Product screenshots or interface mockups as the primary visual element. High contrast between surface (#surface) and text creates the premium feel characteristic of WebGL Awards.
...
4. RE-ENGINEER every UI component (nav, hero, cards, buttons, inputs, footer) into the WebGL Awards visual language while keeping the user's real content, data, and workflows intact.
...
7. VERIFY: The output should feel unmistakably like WebGL Awards's design aesthetic applied to the user's own project domain.
