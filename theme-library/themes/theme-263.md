# THEME #263 --- Collect UI

- **Website URL:** [https://collectui.com/](https://collectui.com/)
...
## 🧬 Theme DNA Summary
> **Collect UI design DNA: Kinetic spring physics, interactive dragging elements, playful typography transforms, and scroll-pinned storytelling.**

---

## 🔑 Signature Visual Element
Deep dark canvas (#0f0f11) with #ff5c00 accent used exclusively on primary actions. Product screenshots or interface mockups as the primary visual element. High contrast between surface (#surface) and text creates the premium feel characteristic of Collect UI.

---

## 🎭 Emotional Intent
Technical precision and professional authority. The user feels Collect UI is built by people who understand their craft deeply. The dark aesthetic communicates focus, speed, and zero compromise on quality.

---

## 🎯 Design Principles ("Why does this look like this?")
Why Collect UI looks like this: Engineered to reward user curiosity, delight through micro-interactions, and make software feel alive.
...
- Mobile apps
- Consumer portfolios
- Collect UI-inspired applications
...
## ❌ Things NOT To Copy
  * Proprietary Collect UI brand logos
  * Exact Collect UI copyrighted assets
...
Your task is to analyze the user's current project / objective, and TRANSFORM / REDESIGN its entire frontend style, visual aesthetic, UX feeling, and component architecture strictly using the design system DNA of THEME #263 (Collect UI - https://collectui.com/).
...
2. TRANSLATE DESIGN DNA (DO NOT COPY PROPRIETARY CONTENT):
   - Do NOT blindly copy placeholder copy, trademarks, or unrelated product catalog from Collect UI (e.g., do not insert "Collect UI" branding or unrelated product listings).
   - DO extract and adopt 100% of Collect UI's visual craft, color palette, typography hierarchy, card structures, spacing rhythm, surface depth, micro-interactions, and UX feeling.

3. ELEVATE & RESKIN EVERY COMPONENT:
   - Reskin the user's existing components (navbars, heroes, product/feature cards, buttons, filters, inputs, modals, footers) into the authentic visual language of THEME #263.
   - Example: If the user's project is an apparel store selling shirts, design a high-craft shirt catalog with Collect UI's signature layouts, typography scale, lighting, and button styles.

==================================================================
🧬 THEME #263 IDENTITY & EMOTIONAL BRIEF
==================================================================
- Permanent Theme ID: THEME #263
- Reference Design Source: Collect UI (https://collectui.com/)
- Mode: dark
- Archetype / Category: Motion / Interaction
- Design Style: Scroll-Driven Interactive Story
- Visual Personality: Collect UI signature design: scroll-driven interactive story, engineered with high-craft aesthetics, structured hierarchy, and platform-native ergonomics.
- Core Design DNA: Collect UI design DNA: Kinetic spring physics, interactive dragging elements, playful typography transforms, and scroll-pinned storytelling.

THE SIGNATURE VISUAL ELEMENT (What makes this theme unmistakably Collect UI):
Deep dark canvas (#0f0f11) with #ff5c00 accent used exclusively on primary actions. Product screenshots or interface mockups as the primary visual element. High contrast between surface (#surface) and text creates the premium feel characteristic of Collect UI.
...
4. RE-ENGINEER every UI component (nav, hero, cards, buttons, inputs, footer) into the Collect UI visual language while keeping the user's real content, data, and workflows intact.
...
7. VERIFY: The output should feel unmistakably like Collect UI's design aesthetic applied to the user's own project domain.
